...
namespace Db4o
{
	...
	public class Db4oFactory
	{
		...
		/// <see cref="Db4o.Config.IConfiguration">IConfiguration</see>
		/// context
		...
		/// <see cref="Db4o.Ext.IExtObjectContainer.Configure()">ObjectContainer</see>
		/// .<br /><br />
		/// </summary>
		/// <returns>
		/// the global
		/// <see cref="Db4o.Config.IConfiguration">configuration</see>
		/// context
		/// </returns>
		...
		/// <summary>
		/// Operates just like
		/// <see cref="OpenClient(Db4o.Config.IConfiguration, string, int, string, string)
		/// 	">OpenClient(Db4o.Config.IConfiguration, string, int, string, string)
		/// 	</see>
		/// , but uses
		/// the global db4o
		/// <see cref="Db4o.Config.IConfiguration">IConfiguration</see>
		...
		/// <see cref="IObjectContainer">IObjectContainer</see>
		/// can be cast to
		/// <see cref="Db4o.Ext.IExtClient">IExtClient</see>
		/// to use extended
		/// <see cref="Db4o.Ext.IExtObjectContainer">IExtObjectContainer</see>
		/// 
		/// and
		/// <see cref="Db4o.Ext.IExtClient">IExtClient</see>
		/// methods.
		...
		/// 	</seealso>
		/// <exception cref="Db4o.Ext.Db4oIOException">I/O operation failed or was unexpectedly interrupted.
		/// 	</exception>
		/// <exception cref="Db4o.Ext.OldFormatException">
		/// open operation failed because the database file
		/// is in old format and
		/// <see cref="Db4o.Config.IConfiguration.AllowVersionUpdates(bool)">Db4o.Config.IConfiguration.AllowVersionUpdates(bool)
		/// 	</see>
		/// 
		/// is set to false.
		/// </exception>
		/// <exception cref="Db4o.Ext.InvalidPasswordException">
		/// password supplied for the connection is
		/// invalid.
		/// </exception>
		[System.ObsoleteAttribute(@"See the Db4o.CS.Db4oClientServer class in db4o client server library for methods to open db4o servers and db4o clients."
			)]
		...
		/// <summary>
		/// Operates just like
		/// <see cref="Db4oEmbedded.OpenFile(Db4o.Config.IEmbeddedConfiguration, string)
		/// 	">Db4oEmbedded.OpenFile(Db4o.Config.IEmbeddedConfiguration, string)</see>
		/// , but uses
		/// the global db4o
		/// <see cref="Db4o.Config.IConfiguration">IConfiguration</see>
		/// context.
		...
		/// a
		/// <see cref="Db4o.Ext.DatabaseFileLockedException">DatabaseFileLockedException
		/// 	</see>
		/// .<br /><br />
		...
		/// <see cref="IObjectContainer">IObjectContainer</see>
		/// </returns>
		/// <seealso cref="Db4o.Config.IConfiguration.ReadOnly(bool)">Db4o.Config.IConfiguration.ReadOnly(bool)
		/// 	</seealso>
		/// <seealso cref="Db4o.Config.IConfiguration.Encrypt(bool)">Db4o.Config.IConfiguration.Encrypt(bool)
		/// 	</seealso>
		/// <seealso cref="Db4o.Config.IConfiguration.Password(string)">Db4o.Config.IConfiguration.Password(string)
		/// 	</seealso>
		/// <exception cref="Db4o.Ext.Db4oIOException">I/O operation failed or was unexpectedly interrupted.
		/// 	</exception>
		/// <exception cref="Db4o.Ext.DatabaseFileLockedException">
		/// the required database file is locked by
		/// another process.
		/// </exception>
		/// <exception cref="Db4o.Ext.IncompatibleFileFormatException">
		/// runtime
		/// <see cref="Db4o.Config.IConfiguration">configuration</see>
		/// is not compatible
		...
		/// is set to false.
		/// </exception>
		/// <exception cref="Db4o.Ext.DatabaseReadOnlyException">database was configured as read-only.
		/// 	</exception>
		[System.ObsoleteAttribute(@"Use Db4oEmbedded.OpenFile(Db4o.Config.IEmbeddedConfiguration, string) instead"
			)]
		...
		/// <summary>
		/// Operates just like
		/// <see cref="OpenServer(Db4o.Config.IConfiguration, string, int)">OpenServer(Db4o.Config.IConfiguration, string, int)
		/// 	</see>
		/// , but uses
		/// the global db4o
		/// <see cref="Db4o.Config.IConfiguration">IConfiguration</see>
		...
		/// <see cref="Db4o.Ext.IExtObjectServer.Port()">Db4o.Ext.IExtObjectServer.Port()
		/// 	</see>
		/// .
		/// </param>
		/// <returns>
