...
using Db4o.Internal.Btree.Algebra;
...
namespace Db4o.Internal.Btree
{
	...
	public class BTreeRangeSingle : IBTreeRange
	{
		private sealed class _IComparison4_14 : IComparison4
		{
			...
			{
				Db4o.Internal.Btree.BTreeRangeSingle xRange = (Db4o.Internal.Btree.BTreeRangeSingle
					)x;
				Db4o.Internal.Btree.BTreeRangeSingle yRange = (Db4o.Internal.Btree.BTreeRangeSingle
					)y;
		...
		private readonly Db4o.Internal.Transaction _transaction;
		...
		public BTreeRangeSingle(Db4o.Internal.Transaction transaction, BTree btree
		...
		public virtual bool Adjacent(Db4o.Internal.Btree.BTreeRangeSingle range
			)
		{
		...
		public virtual bool Overlaps(Db4o.Internal.Btree.BTreeRangeSingle range
			)
		{
			return FirstOverlaps(this, range) || FirstOverlaps(range, this);
		}

		private bool FirstOverlaps(Db4o.Internal.Btree.BTreeRangeSingle x, Db4o.Internal.Btree.BTreeRangeSingle
			 y)
		{
		...
		public virtual Db4o.Internal.Btree.BTreeRangeSingle NewBTreeRangeSingle
			(BTreePointer first, BTreePointer end)
		{
			return new Db4o.Internal.Btree.BTreeRangeSingle(Transaction(), _btree, 
				first, end);
		}
		...
		{
			Db4o.Internal.Btree.BTreeRangeSingle rangeImpl = CheckRangeArgument(range
				);
		...
		private Db4o.Internal.Btree.BTreeRangeSingle CheckRangeArgument(IBTreeRange
			 range)
		{
			if (null == range)
			{
			...
			Db4o.Internal.Btree.BTreeRangeSingle rangeImpl = (Db4o.Internal.Btree.BTreeRangeSingle
				)range;
