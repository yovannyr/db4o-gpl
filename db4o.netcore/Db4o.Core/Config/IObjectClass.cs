...
namespace Db4o.Config
{
	...
	public interface IObjectClass
	{
		...
		/// <see cref="Db4o.Config.IConfiguration.CallConstructors">Db4o.Config.IConfiguration.CallConstructors
		/// </see>
		/// .<br/><br/>
		...
		/// </param>
		/// <seealso cref="Db4o.Config.IConfiguration.CallConstructors">Db4o.Config.IConfiguration.CallConstructors
		/// </seealso>
		...
		/// passed to
		/// <see cref="Db4o.IObjectContainer.Delete">Db4o.IObjectContainer.Delete
		/// </see>
		/// .
		/// <br/><br/>
		/// <b>Caution !</b><br/>
		...
		/// calls to
		/// <see cref="Db4o.IObjectContainer.Store">Db4o.IObjectContainer.Store
		/// </see>
		/// .<br/><br/>
		...
		/// </seealso>
		/// <seealso cref="Db4o.IObjectContainer.Delete">Db4o.IObjectContainer.Delete
		/// </seealso>
		/// <seealso cref="Db4o.Ext.IObjectCallbacks">Using callbacks</seealso>
