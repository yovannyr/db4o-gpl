...
using Db4o.Internal.Metadata;
using Db4o.Internal.Query;
using Db4o.Internal.Query.Processor;
using Db4o.Internal.Query.Result;
using Db4o.Internal.References;
using Db4o.Internal.Replication;
using Db4o.Internal.Slots;
using Db4o.Internal.Threading;
using Db4o.Internal.Weakref;
using Db4o.Query;
using Db4o.Reflect;
...
namespace Db4o.Internal
{
		...
		, IInternal4, IObjectContainerSpec, IInternalObjectContainer
	{
		...
		private readonly Db4o.Internal.References.ReferenceSystemRegistry _referenceSystemRegistry
			 = new Db4o.Internal.References.ReferenceSystemRegistry();
		...
		private Db4o.Internal.Transaction _systemTransaction;

		protected Db4o.Internal.Transaction _transaction;
		...
		public void Activate(Db4o.Internal.Transaction trans, object obj)
		{
			lock (_lock)
			{
		...
		public void Deactivate(Db4o.Internal.Transaction trans, object obj)
		{
		...
		public void Activate(Db4o.Internal.Transaction trans, object obj, IActivationDepth
			 depth)
		{
			lock (_lock)
			{
		...
		private sealed class _IFunction4_189 : IFunction4
		{
			...
			{
				this._enclosing.StillToActivate(this._enclosing.ActivationContextFor(((Db4o.Internal.Transaction
					)trans), obj, depth));
				this._enclosing.ActivatePending(((Db4o.Internal.Transaction)trans));
				return null;
			}
		...
		public void Bind(Transaction trans, object obj, long id)
		{
			lock (_lock)
			{
				...
				{
					throw new Db4oException(Db4o.Internal.Messages.Get(57));
				}
			}
		}
		...
		internal void ShutdownHook()
		{
			...
			{
				Db4o.Internal.Messages.LogErr(ConfigImpl, 50, ToString(), null);
				Close();
			}
			else
			{
				...
				{
					Db4o.Internal.Messages.LogErr(ConfigImpl, 24, null, null);
				}
			}
		}
		...
		{
			FatalException(t, Db4o.Internal.Messages.FatalMsgId);
		}
		...
		internal void FatalException(Exception t, int msgID)
		{
			...
			Db4o.Internal.Messages.LogErr(ConfigImpl, (msgID == Db4o.Internal.Messages
				.FatalMsgId ? 18 : msgID), null, t);
			if (!IsClosed())
			{
				ShutdownObjectContainer();
			}
			throw new Db4oException(Db4o.Internal.Messages.Get(msgID));
		}
		...
		{
			Db4o.Internal.Messages.LogMsg(ConfigImpl, code, msg);
		}
