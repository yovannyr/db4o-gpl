...
namespace Db4o.Internal.Btree
{
	...
	{
		protected Db4o.Internal.Btree.BTreeUpdate _next;
		...
		public virtual Db4o.Internal.Btree.BTreeUpdate RemoveFor(Transaction trans
			)
		{
			if (_transaction == trans)
			{
		...
		public virtual void Append(Db4o.Internal.Btree.BTreeUpdate patch)
		{
		...
		{
			Db4o.Internal.Btree.BTreeUpdate patch = (Db4o.Internal.Btree.BTreeUpdate
		...
		{
			if (newNext is Db4o.Internal.Btree.BTreeUpdate)
			{
				_next = (Db4o.Internal.Btree.BTreeUpdate)newNext;
			}
			else
			{
				_next = null;
		...
		public virtual Db4o.Internal.Btree.BTreeUpdate ReplacePatch(BTreePatch
			 patch, Db4o.Internal.Btree.BTreeUpdate update)
		{
			if (patch == this)
			{
				update._next = _next;
		...
		{
			Db4o.Internal.Btree.BTreeUpdate patchForTransaction = (Db4o.Internal.Btree.BTreeUpdate
				)ForTransaction(trans);
