...
namespace Db4o.Internal
{
	...
	{
		internal Db4o.Internal.Transaction _trans;
		...
		public StatefulBuffer(Db4o.Internal.Transaction trans, int initialBufferSize
			)
		{
			_trans = trans;
		...
		public StatefulBuffer(Db4o.Internal.Transaction trans, int address, int
			 length) : this(trans, length)
		{
			_address = address;
		}

		public StatefulBuffer(Db4o.Internal.Transaction trans, Db4o.Internal.Slots.Slot
			 slot) : this(trans, slot.Address(), slot.Length())
		{
		}

		public StatefulBuffer(Db4o.Internal.Transaction trans, Pointer4 pointer
		...
		public Db4o.Internal.Transaction Transaction()
		{
			return _trans;
		}
		...
		public Db4o.Internal.StatefulBuffer ReadStatefulBuffer()
		{
			int length = ReadInt();
			if (length == 0)
			{
			...
			Db4o.Internal.StatefulBuffer yb = new Db4o.Internal.StatefulBuffer
				(_trans, length);
		...
		{
			UseSlot(new Db4o.Internal.Slots.Slot(address, length));
		}

		public void UseSlot(Db4o.Internal.Slots.Slot slot)
		{
		...
		{
			Db4o.Internal.StatefulBuffer payLoad = new Db4o.Internal.StatefulBuffer
				(_trans, 0, length);
		...
		private void TransferPayLoadAddress(Db4o.Internal.StatefulBuffer toWriter
			, int offset)
		{
		...
		public Db4o.Internal.Slots.Slot Slot()
		{
			return new Db4o.Internal.Slots.Slot(_address, _length);
		}
