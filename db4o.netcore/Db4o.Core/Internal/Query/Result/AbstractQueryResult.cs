...
namespace Db4o.Internal.Query.Result
{
	...
	public abstract class AbstractQueryResult : IQueryResult
	{
		...
		public AbstractQueryResult(Db4o.Internal.Transaction transaction)
		{
		...
		public virtual Db4o.Internal.Query.Result.AbstractQueryResult SupportSize
			()
		{
			return this;
		}

		public virtual Db4o.Internal.Query.Result.AbstractQueryResult SupportSort
			()
		{
			return this;
		}

		public virtual Db4o.Internal.Query.Result.AbstractQueryResult SupportElementAccess
			()
		{
			return this;
		}
		...
		public virtual Db4o.Internal.Query.Result.AbstractQueryResult ToIdList
			()
		{
		...
		protected virtual Db4o.Internal.Query.Result.AbstractQueryResult ToIdTree
			()
		{
