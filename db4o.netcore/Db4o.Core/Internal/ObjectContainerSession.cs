...
namespace Db4o.Internal
{
		...
		, IObjectContainerSpec
	{
		...
		protected readonly Db4o.Internal.Transaction _transaction;

		private bool _closed = false;

		public ObjectContainerSession(ObjectContainerBase server, Db4o.Internal.Transaction
			 trans)
		{
			_server = server;
			_transaction = trans;
		...
		/// <exception cref="Db4o.Constraints.UniqueFieldValueConstraintViolationException
		/// 	"></exception>
		...
		public virtual int InstanceCount(ClassMetadata clazz, Db4o.Internal.Transaction
			 trans)
		{
		...
		public virtual void StoreAll(Db4o.Internal.Transaction transaction, IEnumerator
			 objects)
		{
		...
		public virtual IObjectContainer OpenSession()
		{
			lock (Lock())
			{
				return new Db4o.Internal.ObjectContainerSession(_server);
			}
		}
