...
using Db4o;
using Db4o.CS.Config;
using Db4o.CS.Internal.Config;
using Db4o.Internal;
...
namespace Db4o.CS
{
	...
	/// <br /><br />
	/// <b>Note:<br />
	/// This class is made available in db4o-X.x-cs-java.jar / Db4o.CS.dll</b>
	/// </remarks>
	/// <since>7.5</since>
	public class Db4oClientServer
	{
		...
		/// <summary>
		/// creates a new
		/// <see cref="Db4o.CS.Config.IServerConfiguration">Db4o.CS.Config.IServerConfiguration
		/// 	</see>
		/// </summary>
		...
		/// <summary>
		/// opens an
		/// <see cref="Db4o.IObjectServer">IObjectServer</see>
		...
		/// another process.
		/// </exception>
		/// <exception cref="Db4o.Ext.IncompatibleFileFormatException">runtime</exception>
		...
		/// <seealso cref="OpenServer(Db4o.CS.Config.IServerConfiguration, string, int)
		/// 	">OpenServer(Db4o.CS.Config.IServerConfiguration, string, int)</seealso>
		...
		/// <seealso cref="OpenServer(Db4o.CS.Config.IServerConfiguration, string, int)
		/// 	">OpenServer(Db4o.CS.Config.IServerConfiguration, string, int)</seealso>
		/// <seealso cref="Db4o.IObjectServer.GrantAccess(string, string)">Db4o.IObjectServer.GrantAccess(string, string)
		/// 	</seealso>
		...
		/// <seealso cref="OpenClient(Db4o.CS.Config.IClientConfiguration, string, int, string, string)
		/// 	">OpenClient(Db4o.CS.Config.IClientConfiguration, string, int, string, string)
		/// 	</seealso>
		...
		/// <summary>
		/// creates a new
		/// <see cref="Db4o.CS.Config.IClientConfiguration">Db4o.CS.Config.IClientConfiguration
		/// 	</see>
		/// 
		/// </summary>
