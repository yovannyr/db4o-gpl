...
namespace Db4o.Reflect.Core
{
	...
	public class ReflectConstructorSpec
	{
		...
		public static readonly Db4o.Reflect.Core.ReflectConstructorSpec UnspecifiedConstructor
			 = new Db4o.Reflect.Core.ReflectConstructorSpec(TernaryBool.Unspecified
			);

		public static readonly Db4o.Reflect.Core.ReflectConstructorSpec InvalidConstructor
			 = new Db4o.Reflect.Core.ReflectConstructorSpec(TernaryBool.No);
