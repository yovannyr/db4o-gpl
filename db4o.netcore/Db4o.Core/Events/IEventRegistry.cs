...
namespace Db4o.Events
{
	...
	public interface IEventRegistry
	{
		...
		event System.EventHandler<Db4o.Events.QueryEventArgs> QueryStarted;
		...
		/// <returns>event</returns>
		/// <seealso cref="QueryEventArgs">QueryEventArgs</seealso>
		event System.EventHandler<Db4o.Events.QueryEventArgs> QueryFinished;
		...
		/// <seealso cref="Db4o.IObjectContainer.Store(object)">Db4o.IObjectContainer.Store(object)
		/// 	</seealso>
		event System.EventHandler<Db4o.Events.CancellableObjectEventArgs> Creating;
		...
		/// <returns>event</returns>
		/// <seealso cref="CancellableObjectEventArgs">CancellableObjectEventArgs</seealso>
		/// <seealso cref="Db4o.IObjectContainer.Activate(object, int)">Db4o.IObjectContainer.Activate(object, int)
		/// 	</seealso>
		event System.EventHandler<Db4o.Events.CancellableObjectEventArgs> Activating;
		...
		/// <seealso cref="Db4o.IObjectContainer.Store(object)">Db4o.IObjectContainer.Store(object)
		/// 	</seealso>
		event System.EventHandler<Db4o.Events.CancellableObjectEventArgs> Updating;
		...
		/// <returns>event</returns>
		/// <seealso cref="CancellableObjectEventArgs">CancellableObjectEventArgs</seealso>
		/// <seealso cref="Db4o.IObjectContainer.Delete(object)">Db4o.IObjectContainer.Delete(object)
		/// 	</seealso>
		event System.EventHandler<Db4o.Events.CancellableObjectEventArgs> Deleting;
		...
		/// <returns>event</returns>
		/// <seealso cref="CancellableObjectEventArgs">CancellableObjectEventArgs</seealso>
		/// <seealso cref="Db4o.IObjectContainer.Deactivate(object, int)">Db4o.IObjectContainer.Deactivate(object, int)
		/// 	</seealso>
		event System.EventHandler<Db4o.Events.CancellableObjectEventArgs> Deactivating;
		...
		/// <seealso cref="Db4o.IObjectContainer.Activate(object, int)">Db4o.IObjectContainer.Activate(object, int)
		/// 	</seealso>
		event System.EventHandler<Db4o.Events.ObjectInfoEventArgs> Activated;
		...
		/// <seealso cref="Db4o.IObjectContainer.Store(object)">Db4o.IObjectContainer.Store(object)
		/// 	</seealso>
		event System.EventHandler<Db4o.Events.ObjectInfoEventArgs> Created;
		...
		/// <seealso cref="Db4o.IObjectContainer.Store(object)">Db4o.IObjectContainer.Store(object)
		/// 	</seealso>
		event System.EventHandler<Db4o.Events.ObjectInfoEventArgs> Updated;
		...
		/// <seealso cref="Db4o.IObjectContainer.Delete(object)">Db4o.IObjectContainer.Delete(object)
		/// 	</seealso>
		event System.EventHandler<Db4o.Events.ObjectInfoEventArgs> Deleted;
		...
		/// <seealso cref="Db4o.IObjectContainer.Delete(object)">Db4o.IObjectContainer.Delete(object)
		/// 	</seealso>
		event System.EventHandler<Db4o.Events.ObjectInfoEventArgs> Deactivated;
		...
		/// <seealso cref="Db4o.IObjectContainer.Commit()">Db4o.IObjectContainer.Commit()
		/// 	</seealso>
		event System.EventHandler<Db4o.Events.CommitEventArgs> Committing;
		...
		/// <seealso cref="Db4o.IObjectContainer.Commit()">Db4o.IObjectContainer.Commit()
		/// 	</seealso>
		event System.EventHandler<Db4o.Events.CommitEventArgs> Committed;
		...
		/// <returns>event</returns>
		/// <seealso cref="ObjectInfoEventArgs">ObjectInfoEventArgs</seealso>
		event System.EventHandler<Db4o.Events.ObjectInfoEventArgs> Instantiated;
		...
		event System.EventHandler<Db4o.Events.ClassEventArgs> ClassRegistered;

		/// <summary>
		/// This event is fired when the
		/// <see cref="Db4o.IObjectContainer.Close()">Db4o.IObjectContainer.Close()
		/// 	</see>
		/// is
		/// called.
		/// </summary>
		/// <returns>event</returns>
		event System.EventHandler<Db4o.Events.ObjectContainerEventArgs> Closing;

		/// <summary>
		/// This event is fired when the
		/// <see cref="Db4o.IObjectContainer">Db4o.IObjectContainer</see>
		/// has
		/// finished its startup procedure.
		/// </summary>
		/// <returns>event</returns>
		event System.EventHandler<Db4o.Events.ObjectContainerEventArgs> Opened;
	}
}
