...
namespace Db4o.CS.Internal
{
		...
		, IRunnable, ITransientClass
	{
		...
		private readonly Db4o.CS.Internal.ClassInfoHelper _classInfoHelper;

		private System.EventHandler<Db4o.Events.StringEventArgs> _clientDisconnected;
			...
			serverConfig, int port, bool isEmbeddedServer)
		{
			...
			_classInfoHelper = new Db4o.CS.Internal.ClassInfoHelper(Db4oClientServerLegacyConfigurationBridge
		...
		private sealed class _IClosure4_101 : IClosure4
		{
			...
			public object Run()
			{
				...
				while (!started)
				{
					try
					{
						this._enclosing._startupLock.Snooze(Db4o.CS.Internal.ObjectServerImpl.
		...
		public virtual Db4o.CS.Internal.ClassInfoHelper ClassInfoHelper()
		{
		...
		public virtual event System.EventHandler<Db4o.Events.StringEventArgs> 
			ClientDisconnected
		{
			add
			{
				_clientDisconnected = (System.EventHandler<Db4o.Events.StringEventArgs>
