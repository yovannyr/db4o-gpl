...
using Db4o.Internal.Convert.Conversions;

namespace Db4o.Internal.Convert
{
	/// <exclude></exclude>
	public class Converter
	{
		...
		private static Db4o.Internal.Convert.Converter _instance;
		...
		public static Db4o.Internal.Convert.Converter Instance()
		{
			if (_instance == null)
			{
				_instance = new Db4o.Internal.Convert.Converter();
			}
			return _instance;
		}
