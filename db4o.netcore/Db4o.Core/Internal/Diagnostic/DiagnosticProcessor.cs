...
namespace Db4o.Internal.Diagnostic
{
	...
	public class DiagnosticProcessor : IDiagnosticConfiguration, IDeepClone
	{
		...
		{
			return new Db4o.Internal.Diagnostic.DiagnosticProcessor(CloneListeners
				());
		}

		public virtual void DeletionFailed()
		{
			OnDiagnostic(new Db4o.Diagnostic.DeletionFailed());
		}
		...
		public virtual void LoadedFromClassIndex(ClassMetadata classMetadata)
		{
			...
			OnDiagnostic(new Db4o.Diagnostic.LoadedFromClassIndex(classMetadata.GetName
				()));
		}

		public virtual void DescendIntoTranslator(ClassMetadata parent, string fieldName)
		{
			OnDiagnostic(new Db4o.Diagnostic.DescendIntoTranslator(parent.GetName(
				), fieldName));
		}
		...
		{
			OnDiagnostic(new Db4o.Diagnostic.NativeQueryOptimizerNotLoaded(reason, 
				e));
		}

		public virtual void ObjectFieldDoesNotExist(string className, string fieldName)
		{
			OnDiagnostic(new Db4o.Diagnostic.ObjectFieldDoesNotExist(className, fieldName
				));
		}
