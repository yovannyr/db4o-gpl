...
namespace Db4o.Ext
{
	...
	{
		public static readonly Db4o.Ext.Db4oDatabase StaticIdentity = Debug4.staticIdentity
			 ? new Db4o.Ext.Db4oDatabase(new byte[] { (byte)'d', (byte)'e', (byte
		...
		public static Db4o.Ext.Db4oDatabase Generate()
		{
			StatefulBuffer writer = new StatefulBuffer(null, 300);
			new LatinStringIO().Write(writer, SignatureGenerator.GenerateSignature());
			return new Db4o.Ext.Db4oDatabase(writer.GetWrittenBytes(), Runtime.CurrentTimeMillis
				());
		}
		...
		public override bool Equals(object obj)
		{
			...
			Db4o.Ext.Db4oDatabase other = (Db4o.Ext.Db4oDatabase)obj;
		...
		public virtual bool IsOlderThan(Db4o.Ext.Db4oDatabase peer)
		{
			if (peer == this)
			{
		...
		{
			ObjectContainerBase stream = trans.Container();
			Db4o.Ext.Db4oDatabase stored = (Db4o.Ext.Db4oDatabase)stream
		...
		private Db4o.Ext.Db4oDatabase Query(Transaction trans, bool constrainByUUID
			)
		{
			ObjectContainerBase stream = trans.Container();
			...
			{
				Db4o.Ext.Db4oDatabase storedDatabase = (Db4o.Ext.Db4oDatabase
					)objectSet.Next();
