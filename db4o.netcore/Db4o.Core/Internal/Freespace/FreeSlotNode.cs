...
namespace Db4o.Internal.Freespace
{
	...
	public sealed class FreeSlotNode : TreeInt
	{
		...
		internal Db4o.Internal.Freespace.FreeSlotNode _peer;
		...
		{
			Db4o.Internal.Freespace.FreeSlotNode frslot = new Db4o.Internal.Freespace.FreeSlotNode
				(_key);
			frslot._peer = _peer;
		...
		{
			_peer = new Db4o.Internal.Freespace.FreeSlotNode(a_key);
			_peer._peer = this;
		}
		...
		internal static Tree RemoveGreaterOrEqual(Db4o.Internal.Freespace.FreeSlotNode
			 a_in, TreeIntObject a_finder)
		{
			...
			if (cmp > 0)
			{
				a_in._preceding = RemoveGreaterOrEqual((Db4o.Internal.Freespace.FreeSlotNode
			...
			a_in._subsequent = RemoveGreaterOrEqual((Db4o.Internal.Freespace.FreeSlotNode
		...
		public override object Read(ByteArrayBuffer buffer)
		{
			...
			if (size > sizeLimit)
			{
				Db4o.Internal.Freespace.FreeSlotNode node = new Db4o.Internal.Freespace.FreeSlotNode
					(size);
		...
		private void DebugCheckBuffer(ByteArrayBuffer buffer, Db4o.Internal.Freespace.FreeSlotNode
			 node)
		{
