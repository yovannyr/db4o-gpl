...
namespace Db4o.Foundation
{
	...
	public class Hashtable4 : HashtableBase, IDeepClone, IMap4
	{
		...
		{
			return DeepCloneInternal(new Db4o.Foundation.Hashtable4((IDeepClone)null
				), obj);
		}
		...
		protected virtual Db4o.Foundation.Hashtable4 DeepCloneInternal(Db4o.Foundation.Hashtable4
			 ret, object obj)
		{
			ret._mask = _mask;
