...
namespace Db4o.Config.Encoding
{
	/// <summary>All built in String encodings</summary>
	/// <seealso cref="Db4o.Config.IConfiguration.StringEncoding(IStringEncoding)
	/// 	">Db4o.Config.IConfiguration.StringEncoding(IStringEncoding)</seealso>
