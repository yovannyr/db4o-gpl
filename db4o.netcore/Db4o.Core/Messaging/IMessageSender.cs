...
namespace Db4o.Messaging
{
	...
	/// <b>See Also:</b><br />
	/// <see cref="Db4o.Config.IClientServerConfiguration.GetMessageSender()">Db4o.Config.IClientServerConfiguration.GetMessageSender()
	/// 	</see>
	/// ,<br />
	/// <see cref="IMessageRecipient">IMessageRecipient</see>
	/// ,<br />
	/// <see cref="Db4o.Config.IClientServerConfiguration.SetMessageRecipient(IMessageRecipient)
	/// 	">Db4o.Config.IClientServerConfiguration.SetMessageRecipient(IMessageRecipient)
	/// 	</see>
	/// </remarks>
