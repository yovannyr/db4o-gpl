...
using Db4o.Internal.Classindex;
using Db4o.Internal.Delete;
using Db4o.Internal.Diagnostic;
...
namespace Db4o.Internal
{
	...
	public class ClassMetadata : PersistentBase, IStoredClass
	{
		...
		public Db4o.Internal.ClassMetadata _ancestor;
		...
		private sealed class _ITraverseAspectCommand_162 : ITraverseAspectCommand
		{
			...
			public int DeclaredAspectCount(Db4o.Internal.ClassMetadata classMetadata
				)
			{
		...
		private bool CollectReflectFields(Collection4 collectedAspects)
		{
			...
			for (int reflectFieldIndex = 0; reflectFieldIndex < reflectFieldArray.Length; ++reflectFieldIndex)
			{
				...
				Db4o.Internal.ClassMetadata classMetadata = Handlers4.ErasedFieldType(
		...
		public virtual Db4o.Internal.ClassMetadata GetAncestor()
		{
			return _ancestor;
		}
		...
		public virtual Db4o.Internal.ClassMetadata GetHigherHierarchy(Db4o.Internal.ClassMetadata
			 a_classMetadata)
		{
			Db4o.Internal.ClassMetadata yc = GetHigherHierarchy1(a_classMetadata);
			if (yc != null)
			{
				return yc;
			}
		...
		private Db4o.Internal.ClassMetadata GetHigherHierarchy1(Db4o.Internal.ClassMetadata
			 a_classMetadata)
		{
		...
		public virtual Db4o.Internal.ClassMetadata GetHigherOrCommonHierarchy(
			Db4o.Internal.ClassMetadata a_classMetadata)
		{
			Db4o.Internal.ClassMetadata yc = GetHigherHierarchy1(a_classMetadata);
			if (yc != null)
			{
		...
		internal bool Init(Db4o.Internal.ClassMetadata ancestor)
		{
			if (DTrace.enabled)
			{
		...
		public virtual IStoredField StoredField(string fieldName, object fieldType)
		{
			lock (Lock())
			{
				Db4o.Internal.ClassMetadata fieldTypeFilter = fieldType == null ? null
		...
		{
			public _TraverseFieldCommand_1738(ByRef foundField, string fieldName, Db4o.Internal.ClassMetadata
				 fieldTypeFilter)
			{
			...
			private readonly Db4o.Internal.ClassMetadata fieldTypeFilter;
		}
		...
		public static Db4o.Internal.ClassMetadata ReadClass(ObjectContainerBase
		...
		public virtual bool IsAssignableFrom(Db4o.Internal.ClassMetadata other
			)
		{
			return ClassReflector().IsAssignableFrom(other.ClassReflector());
		}

		public virtual void SetAncestor(Db4o.Internal.ClassMetadata ancestor)
		{
			if (ancestor == this)
			{
				throw new InvalidOperationException();
