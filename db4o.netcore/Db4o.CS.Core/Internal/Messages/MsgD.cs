...
namespace Db4o.CS.Internal.Messages
{
	...
	public class MsgD : Msg
	{
		...
		public Db4o.CS.Internal.Messages.MsgD GetWriterForByte(Transaction trans
			, byte b)
		{
			Db4o.CS.Internal.Messages.MsgD msg = GetWriterForLength(trans, 1);
			msg._payLoad.WriteByte(b);
			return msg;
		}

		public Db4o.CS.Internal.Messages.MsgD GetWriterForBuffer(Transaction trans
			, ByteArrayBuffer buffer)
		{
			Db4o.CS.Internal.Messages.MsgD writer = GetWriterForLength(trans, buffer
				.Length());
			writer.WriteBytes(buffer._buffer);
			return writer;
		}

		public Db4o.CS.Internal.Messages.MsgD GetWriterForLength(Transaction trans
			, int length)
		{
			Db4o.CS.Internal.Messages.MsgD message = (Db4o.CS.Internal.Messages.MsgD
				)PublicClone();
		...
		public Db4o.CS.Internal.Messages.MsgD GetWriter(Transaction trans)
		{
			return GetWriterForLength(trans, 0);
		}

		public Db4o.CS.Internal.Messages.MsgD GetWriterForInts(Transaction trans
			, int[] ints)
		{
			Db4o.CS.Internal.Messages.MsgD message = GetWriterForLength(trans, Const4
		...
		public Db4o.CS.Internal.Messages.MsgD GetWriterForIntArray(Transaction
		...
		public virtual Db4o.CS.Internal.Messages.MsgD GetWriterForIntSequence(
		...
		public Db4o.CS.Internal.Messages.MsgD GetWriterForInt(Transaction a_trans
			, int id)
		{
			Db4o.CS.Internal.Messages.MsgD message = GetWriterForLength(a_trans, Const4
				.IntLength);
			message.WriteInt(id);
			return message;
		}

		public Db4o.CS.Internal.Messages.MsgD GetWriterForIntString(Transaction
		...
		public Db4o.CS.Internal.Messages.MsgD GetWriterForLong(Transaction a_trans
			, long a_long)
		{
			Db4o.CS.Internal.Messages.MsgD message = GetWriterForLength(a_trans, Const4
				.LongLength);
		...
		public Db4o.CS.Internal.Messages.MsgD GetWriterForLongs(Transaction trans
			, long[] longs)
		{
			Db4o.CS.Internal.Messages.MsgD message = GetWriterForLength(trans, Const4
		...
		public virtual Db4o.CS.Internal.Messages.MsgD GetWriterForSingleObject
			(Transaction trans, object obj)
		{
			SerializedGraph serialized = Serializer.Marshall(trans.Container(), obj);
			Db4o.CS.Internal.Messages.MsgD msg = GetWriterForLength(trans, serialized
				.MarshalledLength());
			serialized.Write(msg._payLoad);
			return msg;
		}

		public Db4o.CS.Internal.Messages.MsgD GetWriterForString(Transaction a_trans
			, string str)
		{
			Db4o.CS.Internal.Messages.MsgD message = GetWriterForLength(a_trans, Const4
		...
		public virtual Db4o.CS.Internal.Messages.MsgD GetWriter(StatefulBuffer
			 bytes)
		{
			Db4o.CS.Internal.Messages.MsgD message = GetWriterForLength(bytes.Transaction
				(), bytes.Length());
			 ...
			 a_trans, Socket4Adapter sock, ByteArrayBuffer reader)
		{
			...
			Db4o.CS.Internal.Messages.MsgD command = (Db4o.CS.Internal.Messages.MsgD
				)PublicClone();
