...
namespace Db4o.Foundation
{
	...
	public class HashtableObjectEntry : HashtableIntEntry
	{
		...
		{
			return DeepCloneInternal(new Db4o.Foundation.HashtableObjectEntry(), obj
				);
		}
		...
		protected override HashtableIntEntry DeepCloneInternal(HashtableIntEntry entry, object
			 obj)
		{
			((Db4o.Foundation.HashtableObjectEntry)entry)._objectKey = _objectKey;
		...
		{
			return other is Db4o.Foundation.HashtableObjectEntry ? HasKey(((Db4o.Foundation.HashtableObjectEntry
