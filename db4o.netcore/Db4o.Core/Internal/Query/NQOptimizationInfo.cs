...
namespace Db4o.Internal.Query
{
	...
	{
		private Db4o.Query.Predicate _predicate;

		private string _message;

		private object _optimized;

		public NQOptimizationInfo(Db4o.Query.Predicate predicate, string message
			, object optimized)
		{
		...
		public virtual Db4o.Query.Predicate Predicate()
		{
			return _predicate;
		}
