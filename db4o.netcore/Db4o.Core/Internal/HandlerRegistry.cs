...
using Db4o.Internal.Handlers.Versions;
...
namespace Db4o.Internal
{
	...
	public sealed class HandlerRegistry
	{
		...
		private readonly Db4o.Internal.Diagnostic.DiagnosticProcessor _diagnosticProcessor;
		...
		{
			_openTypeHandler = new Db4o.Internal.OpenTypeHandler(Container());
		...
		internal Db4o.Internal.ArrayType ArrayType(object obj)
		{
			IReflectClass claxx = Reflector().ForObject(obj);
			if (!claxx.IsArray())
			{
				return Db4o.Internal.ArrayType.None;
			}
			if (IsNDimensional(claxx))
			{
				return Db4o.Internal.ArrayType.MultidimensionalArray;
			}
			return Db4o.Internal.ArrayType.PlainArray;
		}
