...
namespace Db4o.Internal
{
	...
	public class ByteArrayBuffer : IReadWriteBuffer
	{
		...
		public bool ContainsTheSame(Db4o.Internal.ByteArrayBuffer other)
		{
			if (other != null)
			{
		...
		public virtual void CopyTo(Db4o.Internal.ByteArrayBuffer to, int fromOffset
		...
		public Db4o.Internal.ByteArrayBuffer ReadEmbeddedObject(Transaction trans
			)
		{
			int address = ReadInt();
			int length = ReadInt();
		...
		public virtual Db4o.Internal.ByteArrayBuffer ReadPayloadReader(int offset
			, int length)
		{
			Db4o.Internal.ByteArrayBuffer payLoad = new Db4o.Internal.ByteArrayBuffer
				(length);
