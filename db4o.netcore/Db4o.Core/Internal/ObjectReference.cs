...
namespace Db4o.Internal
{
	...
	{
		private Db4o.Internal.ClassMetadata _class;

		private object _object;

		private Db4o.Internal.VirtualAttributes _virtualAttributes;

		private Db4o.Internal.ObjectReference _idPreceding;

		private Db4o.Internal.ObjectReference _idSubsequent;

		private int _idSize;

		private Db4o.Internal.ObjectReference _hcPreceding;

		private Db4o.Internal.ObjectReference _hcSubsequent;
		...
		public ObjectReference(Db4o.Internal.ClassMetadata classMetadata, int 
			id) : this(id)
		{
		...
		public virtual void ActivateOn(Db4o.Internal.Transaction transaction, 
		...
		public virtual void Activate(Db4o.Internal.Transaction ta, object obj, 
		...
		internal virtual bool ContinueSet(Db4o.Internal.Transaction trans, IUpdateDepth
			 updateDepth)
		{
		...
		private void ObjectOnNew(Db4o.Internal.Transaction transaction, object
			 obj)
		{
			ObjectContainerBase container = transaction.Container();
		...
		public virtual void Deactivate(Db4o.Internal.Transaction trans, IActivationDepth
			 depth)
		{
		...
		public virtual Db4o.Internal.Transaction Transaction()
		{
		...
		{
			Db4o.Internal.VirtualAttributes va = VirtualAttributes(Transaction());
		...
		public Db4o.Internal.ClassMetadata ClassMetadata()
		{
			return _class;
		}

		public virtual void ClassMetadata(Db4o.Internal.ClassMetadata classMetadata
			)
		{
		...
		public virtual Db4o.Internal.VirtualAttributes ProduceVirtualAttributes
			()
		{
			if (_virtualAttributes == null)
			{
				_virtualAttributes = new Db4o.Internal.VirtualAttributes();
			}
			return _virtualAttributes;
		}

		internal void PeekPersisted(Db4o.Internal.Transaction trans, IActivationDepth
			 depth)
		{
			SetObject(Read(trans, depth, Const4.Transient, false));
		}

		internal object Read(Db4o.Internal.Transaction trans, IActivationDepth
		...
		public object Read(Db4o.Internal.Transaction trans, ByteArrayBuffer buffer
		...
		public virtual object ReadPrefetch(Db4o.Internal.Transaction trans, ByteArrayBuffer
		...
		public void ReadThis(Db4o.Internal.Transaction trans, ByteArrayBuffer 
			buffer)
		{
		}
		...
		internal void Store(Db4o.Internal.Transaction trans, Db4o.Internal.ClassMetadata
		...
		public virtual Db4o.Internal.VirtualAttributes VirtualAttributes()
		{
			return _virtualAttributes;
		}

		public virtual Db4o.Internal.VirtualAttributes VirtualAttributes(Db4o.Internal.Transaction
		...
		public virtual void SetVirtualAttributes(Db4o.Internal.VirtualAttributes
			 at)
		{
			_virtualAttributes = at;
		}

		public virtual void WriteThis(Db4o.Internal.Transaction trans, ByteArrayBuffer
			 buffer)
		{
		}

		public virtual void WriteUpdate(Db4o.Internal.Transaction transaction, 
		...
		protected virtual bool ObjectCanUpdate(Db4o.Internal.Transaction transaction
			, object obj)
		{
			ObjectContainerBase container = transaction.Container();
		...
		public virtual Db4o.Internal.ObjectReference Hc_add(Db4o.Internal.ObjectReference
			 newRef)
		{
		...
		private Db4o.Internal.ObjectReference Hc_add1(Db4o.Internal.ObjectReference
			 newRef)
		{
		...
		private Db4o.Internal.ObjectReference Hc_balance()
		{
		...
		private int Hc_compare(Db4o.Internal.ObjectReference toRef)
		{
		...
		public virtual Db4o.Internal.ObjectReference Hc_find(object obj)
		{
			return Hc_find(Hc_getCode(obj), obj);
		}

		private Db4o.Internal.ObjectReference Hc_find(int id, object obj)
		{
			...
			else
			{
				...
				else
				{
					...
					if (_hcPreceding != null)
					{
						Db4o.Internal.ObjectReference inPreceding = _hcPreceding.Hc_find(id, obj
							);
						if (inPreceding != null)
						{
							return inPreceding;
		...
		private Db4o.Internal.ObjectReference Hc_rotateLeft()
		{
			Db4o.Internal.ObjectReference tree = _hcSubsequent;
		...
		private Db4o.Internal.ObjectReference Hc_rotateRight()
		{
			Db4o.Internal.ObjectReference tree = _hcPreceding;
		...
		private Db4o.Internal.ObjectReference Hc_rotateSmallestUp()
		{
			if (_hcPreceding != null)
			{
		...
		public virtual Db4o.Internal.ObjectReference Hc_remove(Db4o.Internal.ObjectReference
			 findRef)
		{
			if (this == findRef)
			{
		...
		private Db4o.Internal.ObjectReference Hc_remove()
		{
		...
		public virtual Db4o.Internal.ObjectReference Id_add(Db4o.Internal.ObjectReference
			 newRef)
		{
			newRef.Id_init();
		...
		private Db4o.Internal.ObjectReference Id_add1(Db4o.Internal.ObjectReference
			 newRef)
		{
		...
		private Db4o.Internal.ObjectReference Id_balance()
		{
		...
		public virtual Db4o.Internal.ObjectReference Id_find(int id)
		{
			int cmp = id - _id;
			if (cmp > 0)
			{
		...
		private Db4o.Internal.ObjectReference Id_rotateLeft()
		{
			Db4o.Internal.ObjectReference tree = _idSubsequent;
		...
		private Db4o.Internal.ObjectReference Id_rotateRight()
		{
			Db4o.Internal.ObjectReference tree = _idPreceding;
		...
		private Db4o.Internal.ObjectReference Id_rotateSmallestUp()
		{
			if (_idPreceding != null)
			{
		...
		public virtual Db4o.Internal.ObjectReference Id_remove(Db4o.Internal.ObjectReference
			 @ref)
		{
			int cmp = @ref._id - _id;
			if (cmp < 0)
		...
		private Db4o.Internal.ObjectReference Id_remove()
		{
