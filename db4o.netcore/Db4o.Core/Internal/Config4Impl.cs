...
namespace Db4o.Internal
{
		...
		, IFreespaceConfiguration, IQueryConfiguration, IClientServerConfiguration
	{
		...
		private sealed class _IDeferred_85 : KeySpec.IDeferred
		{
			...
			public object Evaluate()
			{
				return new Db4o.Internal.Diagnostic.DiagnosticProcessor();
			}
		}
		...
		/// <see cref="Db4o.Config.IConfigurationItem">Db4o.Config.IConfigurationItem
		/// 	</see>
		/// instances
		/// added.
		/// </summary>
		/// <seealso cref="Add(Db4o.Config.IConfigurationItem)">Add(Db4o.Config.IConfigurationItem)
		/// 	</seealso>
		...
		internal void EnsureDirExists(string path)
		{
			...
			{
				throw new IOException(Db4o.Internal.Messages.Get(37, path));
			}
		}
		...
		internal void Rename(Db4o.Rename a_rename)
		{
		...
		public void SetOut(TextWriter outStream)
		{
			...
			{
				Db4o.Internal.Messages.LogMsg(this, 19, Db4oFactory.Version());
			}
		}
		...
		public void UpdateDepth(int depth)
		{
			...
			Db4o.Internal.Diagnostic.DiagnosticProcessor dp = DiagnosticProcessor(
				);
			if (dp.Enabled())
			{
		...
		public Db4o.Internal.Diagnostic.DiagnosticProcessor DiagnosticProcessor
			()
		{
			return (Db4o.Internal.Diagnostic.DiagnosticProcessor)_config.Get(DiagnosticKey
				);
		}
