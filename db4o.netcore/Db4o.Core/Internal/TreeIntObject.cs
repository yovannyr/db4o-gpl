...
namespace Db4o.Internal
{
	...
	public class TreeIntObject : TreeInt
	{
		...
		{
			return ShallowCloneInternal(new Db4o.Internal.TreeIntObject(_key));
		}

		protected override Tree ShallowCloneInternal(Tree tree)
		{
			Db4o.Internal.TreeIntObject tio = (Db4o.Internal.TreeIntObject
		...
		public override object Read(ByteArrayBuffer a_bytes)
		{
			...
			return new Db4o.Internal.TreeIntObject(key, obj);
		}
		...
		public static Db4o.Internal.TreeIntObject Add(Db4o.Internal.TreeIntObject
			 tree, int key, object value)
		{
			return ((Db4o.Internal.TreeIntObject)Tree.Add(tree, new Db4o.Internal.TreeIntObject
				(key, value)));
		}
	}
}
