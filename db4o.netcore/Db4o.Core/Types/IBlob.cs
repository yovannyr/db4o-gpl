...
namespace Db4o.Types
{
	...
	public interface IBlob : IDb4oType
	{
		...
		/// <see cref="Db4o.Ext.Status.Unused">Db4o.Ext.Status.Unused</see>
		/// no data was ever stored to the Blob field.<br />
		/// <see cref="Db4o.Ext.Status.Available">Db4o.Ext.Status.Available
		/// 	</see>
		/// available data was previously stored to the Blob field.<br />
		/// <see cref="Db4o.Ext.Status.Queued">Db4o.Ext.Status.Queued</see>
		/// an operation was triggered and is waiting for it's turn in the Blob queue.<br />
		/// <see cref="Db4o.Ext.Status.Completed">Db4o.Ext.Status.Completed
		/// 	</see>
		/// the last operation on this field was completed successfully.<br />
		/// <see cref="Db4o.Ext.Status.Processing">Db4o.Ext.Status.Processing
		/// 	</see>
		/// for internal use only.<br />
		/// <see cref="Db4o.Ext.Status.Error">Db4o.Ext.Status.Error</see>
		...
		/// <see cref="Db4o.Ext.Status">Db4o.Ext.Status</see>
		...
		/// <seealso cref="Db4o.Ext.Status">constants</seealso>
		double GetStatus();
