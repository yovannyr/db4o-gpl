...
namespace Db4o.Typehandlers
{
	...
	/// <seealso>
	/// 
	/// <see cref="Db4o.Config.IConfiguration.RegisterTypeHandler(ITypeHandlerPredicate, ITypeHandler4)
	/// 	">Db4o.Config.IConfiguration.RegisterTypeHandler(ITypeHandlerPredicate, ITypeHandler4)
	/// 	</see>
	/// 
	/// </seealso>
	public interface ITypeHandler4
	{
		...
		/// <exception cref="Db4o.Ext.Db4oIOException">Db4o.Ext.Db4oIOException
		/// 	</exception>
