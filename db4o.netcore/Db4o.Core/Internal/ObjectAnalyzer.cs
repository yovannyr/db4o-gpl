...
namespace Db4o.Internal
{
	...
	internal class ObjectAnalyzer
	{
		...
		private Db4o.Internal.ObjectReference _ref;
		...
		private bool IsValueType(Db4o.Internal.ClassMetadata classMetadata)
		{
			return classMetadata.IsValueType();
		}

		internal virtual Db4o.Internal.ObjectReference ObjectReference()
		{
			return _ref;
		}
