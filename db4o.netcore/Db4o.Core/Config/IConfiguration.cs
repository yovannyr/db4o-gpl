...
using Db4o.Diagnostic;
using Db4o.IO;
using Db4o.Reflect;
using Db4o.Typehandlers;

namespace Db4o.Config
{
	...
	/// <see cref="Db4o.Db4oFactory.Configure()">Db4o.Db4oFactory.Configure()
	/// 	</see>
	/// .
	...
	/// available with
	/// <see cref="Db4o.Ext.IExtObjectContainer.Configure()">Db4o.Ext.IExtObjectContainer.Configure()
	/// 	</see>
	/// and
	/// <see cref="Db4o.Ext.IExtObjectServer.Configure()">Db4o.Ext.IExtObjectServer.Configure()
	/// 	</see>
	/// .
	/// </remarks>
	public interface IConfiguration
	{
		...
		/// <see cref="Db4o.IObjectSet">IObjectSet</see>
		...
		/// <see cref="Db4o.IObjectContainer.Activate">IObjectContainer.Activate(member5, depth)
		/// </see>
		/// .
		/// <br/><br/>
		...
		/// <see cref="Db4o.IObjectContainer.Deactivate">IObjectContainer.Deactivate(object, depth)
		/// </see>
		...
		/// 
		/// <seealso cref="Db4o.Config.IObjectClass.MaximumActivationDepth">configuring classes individually
		/// </seealso>
		/// 
		...
		/// <exception cref="Db4o.Config.GlobalOnlyConfigException"></exception>
		...
		/// <seealso cref="Db4o.Ext.IObjectCallbacks">Using callbacks</seealso>
		...
		/// <see cref="Db4o.Config.IObjectClass.CallConstructor">Db4o.Config.IObjectClass.CallConstructor
		/// </see>
		/// .
		...
		/// </param>
		/// <seealso cref="Db4o.Config.IObjectClass.CallConstructor">Db4o.Config.IObjectClass.CallConstructor
		/// </seealso>
		...
		/// <see cref="Db4o.Db4oFactory.OpenFile(string)">Db4o.Db4oFactory.OpenFile(string)
		/// 	</see>
		/// .
		...
		/// <see cref="Db4o.Ext.ObjectNotStorableException">ObjectNotStorableException
		/// 	</see>
		...
		/// <see cref="Db4o.IO.IStorage">Db4o.IO.IStorage</see>
		/// to
		...
		/// <seealso cref="Db4o.IO.CachingStorage">Db4o.IO.CachingStorage
		/// 	</seealso>
		/// <seealso cref="Db4o.IO.MemoryStorage">Db4o.IO.MemoryStorage
		/// 	</seealso>
		/// <seealso cref="Db4o.IO.FileStorage">Db4o.IO.FileStorage</seealso>
		/// <seealso cref="Db4o.IO.StorageDecorator">Db4o.IO.StorageDecorator
		/// 	</seealso>
		/// <exception cref="Db4o.Config.GlobalOnlyConfigException"></exception>
		/// <summary>
		...
		/// Db4o.NativeQueries.dll, Db4o.Instrumentation.dll.
		...
		/// </param>
		/// 
		/// <seealso cref="Db4o.Config.ICommonConfiguration.OptimizeNativeQueries">Db4o.Config.ICommonConfiguration.OptimizeNativeQueries</seealso>
		...
		/// <see cref="Db4o.Db4oFactory.OpenFile(string)">Db4o.openFile()</see>
		/// will open files.
		...
		/// calls to
		/// <see cref="Db4o.Db4oEmbedded.OpenFile(string)">Db4o.openFile()</see>
		/// .
		/// </param>
		...
		/// <exception cref="Db4o.Ext.DatabaseReadOnlyException"></exception>
		...
		/// <see cref="Db4o.Db4oFactory.OpenFile">Db4o.Db4oFactory.OpenFile
		/// </see>
		/// or
		/// <see cref="Db4o.Db4oFactory.OpenServer">Db4o.Db4oFactory.OpenServer
		/// </see>
		/// .
		...
		/// </remarks>
		/// <seealso cref="Db4o.Config.Encoding.StringEncodings">Db4o.Config.Encoding.StringEncodings
		/// </seealso>
