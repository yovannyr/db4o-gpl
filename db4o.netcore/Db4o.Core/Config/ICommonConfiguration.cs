...
namespace Db4o.Config
{
	...
	public interface ICommonConfiguration
	{
		...
		/// <see cref="Db4o.IObjectContainer.Store(object)"></see>
		...
		/// <see cref="Db4o.Ext.IExtObjectContainer.Purge(object)">Db4o.Ext.IExtObjectContainer.Purge(object)
		/// 	</see>
		...
		/// <seealso cref="Db4o.Foundation.IEnvironment">Db4o.Foundation.IEnvironment
		/// 	</seealso>
		...
		/// <see cref="Db4o.Internal.Const4.DefaultMaxStackDepth">Db4o.Internal.Const4.DefaultMaxStackDepth
		/// 	</see>
