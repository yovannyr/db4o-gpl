...
namespace Db4o.TA
{
	...
	/// </remarks>
	/// <seealso cref="Db4o.TA.TransparentActivationSupport">Db4o.TA.TransparentActivationSupport
	/// </seealso>
	public class TransparentPersistenceSupport : TransparentActivationSupport
	{
		...
		/// 	</summary>
		/// <seealso cref="TransparentActivationSupport.Apply(Db4o.Internal.IInternalObjectContainer)
		/// 	"></seealso>
