...
namespace Db4o.Internal.Ids
{
	...
	public class IdSlotMapping
	{
		...
		public IdSlotMapping(int id, Db4o.Internal.Slots.Slot slot) : this(id, 
		...
		public static Db4o.Internal.Ids.IdSlotMapping Read(ByteArrayBuffer buffer
			)
		{
			return new Db4o.Internal.Ids.IdSlotMapping(buffer.ReadInt(), buffer.ReadInt
				(), buffer.ReadInt());
		}
