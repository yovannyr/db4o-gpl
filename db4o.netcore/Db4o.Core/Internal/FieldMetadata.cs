...
namespace Db4o.Internal
{
	...
	public class FieldMetadata : ClassAspect, IStoredField
	{
		...
		internal static readonly Db4o.Internal.FieldMetadata[] EmptyArray = new 
			Db4o.Internal.FieldMetadata[0];
		...
		/// <exception cref="Db4o.Internal.FieldIndexException"></exception>
		...
		/// <exception cref="Db4o.CorruptionException"></exception>
		...
		{
			if (!(obj is Db4o.Internal.FieldMetadata))
			{
				return false;
			}
			Db4o.Internal.FieldMetadata other = (Db4o.Internal.FieldMetadata
				)obj;
			other.Alive();
			Alive();
		...
		public virtual Db4o.Internal.Query.Processor.QField QField(Transaction
			 a_trans)
		{
			...
			return new Db4o.Internal.Query.Processor.QField(a_trans, _name, this, 
		...
		public void TraverseValues(Transaction transaction, IVisitor4 userVisitor)
		{
			...
			if (stream.IsClient)
			{
				Exceptions4.ThrowRuntimeException(Db4o.Internal.Messages.ClientServerUnsupported
					);
			}
			lock (stream.Lock())
			{
		...
		private void AssertHasIndex()
		{
			if (!HasIndex())
			{
				Exceptions4.ThrowRuntimeException(Db4o.Internal.Messages.OnlyForIndexedFields
					);
			}
		}
		...
		public override Db4o.Internal.Marshall.AspectType AspectType()
		{
			return Db4o.Internal.Marshall.AspectType.Field;
		}
