...
namespace Db4o.Defragment
{
	...
	public class DefragmentServicesImpl : IDefragmentServices
	{
		public abstract class DbSelector
		{
			...
			internal virtual Db4o.Internal.Transaction Transaction(DefragmentServicesImpl
				 context)
			{
		...
		/// <exception cref="Db4o.Internal.Mapping.MappingNotFoundException"></exception>
		...
		public virtual Db4o.Internal.Transaction SystemTrans()
		{
		...
		{
			Db4o.Internal.Transaction systemTransaction = _targetDb.SystemTransaction
				();
