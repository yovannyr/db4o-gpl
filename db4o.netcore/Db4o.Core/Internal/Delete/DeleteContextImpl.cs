...
namespace Db4o.Internal.Delete
{
	/// <exclude></exclude>
	public class DeleteContextImpl : ObjectHeaderContext, IDeleteContext, IObjectIdContext
	{
		...
		public DeleteContextImpl(Db4o.Internal.StatefulBuffer buffer, ObjectHeader
		...
		public DeleteContextImpl(Db4o.Internal.Delete.DeleteContextImpl parentContext
		...
		private Db4o.Internal.StatefulBuffer StatefulBuffer()
		{
			return ((Db4o.Internal.StatefulBuffer)Buffer());
		}
