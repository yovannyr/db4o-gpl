...
namespace Db4o.Constraints
{
	...
	/// <see cref="Db4o.Config.ICommonConfiguration.Add(Db4o.Config.IConfigurationItem)
	/// 	">Db4o.Config.ICommonConfiguration.Add(Db4o.Config.IConfigurationItem)
	/// 	</see>
	/// </remarks>
	public class UniqueFieldValueConstraint : IConfigurationItem
	{
		...
		public virtual void Apply(IInternalObjectContainer objectContainer)
		{
			...
			EventRegistryFactory.ForObjectContainer(objectContainer).Committing += new System.EventHandler<Db4o.Events.CommitEventArgs>
		...
		private sealed class _IEventListener4_52
		{
			...
			public void OnEvent(object sender, Db4o.Events.CommitEventArgs args)
			{
