...
namespace Db4o.Foundation
{
	...
	public sealed class List4 : IUnversioned
	{
		...
		public Db4o.Foundation.List4 _next;
		...
		public List4(Db4o.Foundation.List4 next, object element)
		{
			_next = next;
			_element = element;
		}
		...
		public static int Size(Db4o.Foundation.List4 list)
		{
			int counter = 0;
			Db4o.Foundation.List4 nextList = list;
			while (nextList != null)
			{
				counter++;
				nextList = ((Db4o.Foundation.List4)nextList._next);
			}
			return counter;
		}
	}
