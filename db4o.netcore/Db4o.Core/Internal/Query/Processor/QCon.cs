...
namespace Db4o.Internal.Query.Processor
{
	...
	public abstract class QCon : IConstraint, IVisitor4, IUnversioned
	{
		...
		protected Db4o.Internal.Query.Processor.QCon i_parent;

		[System.NonSerialized]
		internal Db4o.Internal.Transaction i_trans;
		...
		internal QCon(Db4o.Internal.Transaction a_trans)
		{
		...
		internal virtual Db4o.Internal.Query.Processor.QCon AddConstraint(Db4o.Internal.Query.Processor.QCon
			 a_child)
		{
		...
		internal virtual Db4o.Internal.Query.Processor.QCon AddSharedConstraint
		...
		{
			Db4o.Internal.Query.Processor.QCon qcon = this;
		...
		private sealed class _IVisitor4_101 : IVisitor4
		{
			...
			{
				foundField[0] = true;
				query.AddConstraint((Db4o.Internal.Query.Processor.QCon)obj);
			}
		...
		internal virtual void EvaluateCreateChildrenCandidates()
		{
			...
			while (i.MoveNext())
			{
				Db4o.Internal.Query.Processor.QCon constraint = (Db4o.Internal.Query.Processor.QCon
					)i.Current;
		...
		private bool ResolvedByIndex()
		{
			...
			while (it.MoveNext())
			{
				Db4o.Internal.Query.Processor.QCon childConstraint = (Db4o.Internal.Query.Processor.QCon
					)it.Current;
		...
		internal virtual void EvaluateEvaluations()
		{
			...
			while (i.MoveNext())
			{
				((Db4o.Internal.Query.Processor.QCon)i.Current).EvaluateEvaluationsExec
					(i_candidates, true);
			}
		}
		...
		internal virtual void EvaluateSimpleChildren()
		{
			...
			while (i.MoveNext())
			{
				Db4o.Internal.Query.Processor.QCon qcon = (Db4o.Internal.Query.Processor.QCon
					)i.Current;
		...
		// virtual
		internal virtual void ExchangeConstraint(Db4o.Internal.Query.Processor.QCon
			 a_exchange, Db4o.Internal.Query.Processor.QCon a_with)
		{
			List4 previous = null;
		...
		internal virtual Db4o.Internal.Query.Processor.QCon GetRoot()
		{
			if (i_parent != null)
			{
		...
		internal virtual Db4o.Internal.Query.Processor.QCon ProduceTopLevelJoin
			()
		{
			if (!HasJoins())
			{
			...
			{
				i.MoveNext();
				return ((Db4o.Internal.Query.Processor.QCon)i.Current).ProduceTopLevelJoin
					();
			}
			Collection4 col = new Collection4();
			while (i.MoveNext())
			{
				col.Ensure(((Db4o.Internal.Query.Processor.QCon)i.Current).ProduceTopLevelJoin
					());
			}
			i = col.GetEnumerator();
			i.MoveNext();
			...
			while (i.MoveNext())
			{
				qcon = (Db4o.Internal.Query.Processor.QCon)qcon.And((IConstraint)i.Current
					);
			}
			return qcon;
		}
		...
		public virtual Db4o.Internal.Query.Processor.QCon Parent()
		{
			return i_parent;
		}
		...
		{
			if (!(a_with is Db4o.Internal.Query.Processor.QCon))
			{
			...
			return Join1((Db4o.Internal.Query.Processor.QCon)a_with, a_and);
		}

		internal virtual IConstraint Join1(Db4o.Internal.Query.Processor.QCon 
			a_with, bool a_and)
		{
			if (a_with is QConstraints)
			{
				...
				{
					joinHooks.Ensure(((Db4o.Internal.Query.Processor.QCon)constraints[j]).
						JoinHook());
				}
			...
			Db4o.Internal.Query.Processor.QCon myHook = JoinHook();
			Db4o.Internal.Query.Processor.QCon otherHook = a_with.JoinHook();
			if (myHook == otherHook)
			{
		...
		internal virtual Db4o.Internal.Query.Processor.QCon JoinHook()
		{
		...
		internal virtual void Marshall()
		{
			...
			while (i.MoveNext())
			{
				((Db4o.Internal.Query.Processor.QCon)i.Current).Marshall();
			}
		}
		...
		public virtual bool OnSameFieldAs(Db4o.Internal.Query.Processor.QCon other
			)
		{
			return false;
		}
		...
		internal virtual void SetParent(Db4o.Internal.Query.Processor.QCon a_newParent
			)
		{
		...
		internal virtual Db4o.Internal.Query.Processor.QCon ShareParent(object
		...
		internal virtual void Unmarshall(Db4o.Internal.Transaction a_trans)
		{
			if (i_trans != null)
			{
				return;
		...
		private void UnmarshallParent(Db4o.Internal.Transaction a_trans)
		{
			if (i_parent != null)
			{
		...
		private void UnmarshallChildren(Db4o.Internal.Transaction a_trans)
		{
			IEnumerator i = IterateChildren();
			while (i.MoveNext())
			{
				((Db4o.Internal.Query.Processor.QCon)i.Current).Unmarshall(a_trans);
			}
		}

		private void UnmarshallJoins(Db4o.Internal.Transaction a_trans)
		{
			if (HasJoins())
			{
				IEnumerator i = IterateJoins();
		...
		internal virtual void Visit1(IInternalCandidate root, Db4o.Internal.Query.Processor.QCon
			 reason, bool res)
		{
		...
		internal void VisitOnNull(IInternalCandidate a_root)
		{
			...
			while (i.MoveNext())
			{
				((Db4o.Internal.Query.Processor.QCon)i.Current).VisitOnNull(a_root);
			}
			if (VisitSelfOnNull())
			{
