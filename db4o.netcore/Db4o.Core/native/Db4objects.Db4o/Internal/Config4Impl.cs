    ...
    public partial class Config4Impl
    {
        private static ILegacyClientServerFactory DefaultClientServerFactory()
        {
            foreach (var asm in AppDomain.CurrentDomain.GetAssemblies())
            {
                ...
                {
                    var t = asm.GetType("Db4o.CS.Internal.Config.LegacyClientServerFactoryImpl");
                    if (t != null)
                    {
            ...
            //return (ILegacyClientServerFactory) Activator.CreateInstance(csAssembly.GetType("Db4o.CS.Internal.Config.LegacyClientServerFactoryImpl"));
        }
...
/*
		private static string ClientServerAssemblyName()
		{
			...
			string db4oAssemblySimpleName = "Db4o-gpl";// db4oAssembly.GetName().Name;
			return db4oAssembly.FullName.Replace(db4oAssemblySimpleName, "Db4o.CS");
		}*/
    }
}