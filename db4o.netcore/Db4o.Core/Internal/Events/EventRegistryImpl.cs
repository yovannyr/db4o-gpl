...
namespace Db4o.Internal.Events
{
	/// <exclude></exclude>
	public class EventRegistryImpl : ICallbacks, IEventRegistry
	{
		protected System.EventHandler<Db4o.Events.QueryEventArgs> _queryStarted;

		protected System.EventHandler<Db4o.Events.QueryEventArgs> _queryFinished;

		protected System.EventHandler<Db4o.Events.CancellableObjectEventArgs> 
			_creating;
		...
		protected System.EventHandler<Db4o.Events.ObjectInfoEventArgs> _created;

		protected System.EventHandler<Db4o.Events.ObjectInfoEventArgs> _activated;

		protected System.EventHandler<Db4o.Events.ObjectInfoEventArgs> _updated;

		protected System.EventHandler<Db4o.Events.ObjectInfoEventArgs> _deleted;

		protected System.EventHandler<Db4o.Events.ObjectInfoEventArgs> _deactivated;

		protected System.EventHandler<Db4o.Events.CommitEventArgs> _committing;

		protected System.EventHandler<Db4o.Events.CommitEventArgs> _committed;

		protected System.EventHandler<Db4o.Events.ObjectInfoEventArgs> _instantiated;

		protected System.EventHandler<Db4o.Events.ClassEventArgs> _classRegistered;

		protected System.EventHandler<Db4o.Events.ObjectContainerEventArgs> _closing;

		protected System.EventHandler<Db4o.Events.ObjectContainerEventArgs> _opened;
		...
		public virtual event System.EventHandler<Db4o.Events.QueryEventArgs> QueryFinished
		{
			add
			{
				_queryFinished = (System.EventHandler<Db4o.Events.QueryEventArgs>)System.Delegate.Combine
					(_queryFinished, value);
			}
			remove
			{
				_queryFinished = (System.EventHandler<Db4o.Events.QueryEventArgs>)System.Delegate.Remove
					(_queryFinished, value);
			}
		}

		public virtual event System.EventHandler<Db4o.Events.QueryEventArgs> QueryStarted
		{
			add
			{
				_queryStarted = (System.EventHandler<Db4o.Events.QueryEventArgs>)System.Delegate.Combine
					(_queryStarted, value);
			}
			remove
			{
				_queryStarted = (System.EventHandler<Db4o.Events.QueryEventArgs>)System.Delegate.Remove
					(_queryStarted, value);
			}
		}

		public virtual event System.EventHandler<Db4o.Events.CancellableObjectEventArgs>
			 Creating
		{
			add
			{
				_creating = (System.EventHandler<Db4o.Events.CancellableObjectEventArgs>
			 ...
			 Activating
		{
			add
			{
				_activating = (System.EventHandler<Db4o.Events.CancellableObjectEventArgs>
			 ...
			 Updating
		{
			add
			{
				_updating = (System.EventHandler<Db4o.Events.CancellableObjectEventArgs>
			 ...
			 Deleting
		{
			add
			{
				_deleting = (System.EventHandler<Db4o.Events.CancellableObjectEventArgs>
			 ...
			 Deactivating
		{
			add
			{
				_deactivating = (System.EventHandler<Db4o.Events.CancellableObjectEventArgs>
		...
		public virtual event System.EventHandler<Db4o.Events.ObjectInfoEventArgs>
			 Created
		{
			add
			{
				_created = (System.EventHandler<Db4o.Events.ObjectInfoEventArgs>)System.Delegate.Combine
					(_created, value);
			}
			remove
			{
				_created = (System.EventHandler<Db4o.Events.ObjectInfoEventArgs>)System.Delegate.Remove
					(_created, value);
			}
		}
			 ...
			 Activated
		{
			add
			{
				_activated = (System.EventHandler<Db4o.Events.ObjectInfoEventArgs>)System.Delegate.Combine
					(_activated, value);
			}
			remove
			{
				_activated = (System.EventHandler<Db4o.Events.ObjectInfoEventArgs>)System.Delegate.Remove
					(_activated, value);
			}
		}
			 ...
			 Updated
		{
			add
			{
				_updated = (System.EventHandler<Db4o.Events.ObjectInfoEventArgs>)System.Delegate.Combine
					(_updated, value);
			}
			remove
			{
				_updated = (System.EventHandler<Db4o.Events.ObjectInfoEventArgs>)System.Delegate.Remove
					(_updated, value);
			}
		}
			 ...
			 Deleted
		{
			add
			{
				_deleted = (System.EventHandler<Db4o.Events.ObjectInfoEventArgs>)System.Delegate.Combine
					(_deleted, value);
			}
			remove
			{
				_deleted = (System.EventHandler<Db4o.Events.ObjectInfoEventArgs>)System.Delegate.Remove
					(_deleted, value);
			}
		}
			 ...
			 Deactivated
		{
			add
			{
				_deactivated = (System.EventHandler<Db4o.Events.ObjectInfoEventArgs>)System.Delegate.Combine
					(_deactivated, value);
			}
			remove
			{
				_deactivated = (System.EventHandler<Db4o.Events.ObjectInfoEventArgs>)System.Delegate.Remove
					(_deactivated, value);
			}
		}

		public virtual event System.EventHandler<Db4o.Events.CommitEventArgs> 
			Committing
		{
			add
			{
				_committing = (System.EventHandler<Db4o.Events.CommitEventArgs>)System.Delegate.Combine
					(_committing, value);
			}
			remove
			{
				_committing = (System.EventHandler<Db4o.Events.CommitEventArgs>)System.Delegate.Remove
					(_committing, value);
			}
		}
			...
			Committed
		{
			add
			{
				_committed = (System.EventHandler<Db4o.Events.CommitEventArgs>)System.Delegate.Combine
					(_committed, value);
				OnCommittedListenerAdded();
			}
			remove
			{
				_committed = (System.EventHandler<Db4o.Events.CommitEventArgs>)System.Delegate.Remove
					(_committed, value);
			}
		}

		public virtual event System.EventHandler<Db4o.Events.ClassEventArgs> ClassRegistered
		{
			add
			{
				_classRegistered = (System.EventHandler<Db4o.Events.ClassEventArgs>)System.Delegate.Combine
					(_classRegistered, value);
			}
			remove
			{
				_classRegistered = (System.EventHandler<Db4o.Events.ClassEventArgs>)System.Delegate.Remove
					(_classRegistered, value);
			}
		}
			 ...
			 Instantiated
		{
			add
			{
				_instantiated = (System.EventHandler<Db4o.Events.ObjectInfoEventArgs>)
		...
		public virtual event System.EventHandler<Db4o.Events.ObjectContainerEventArgs>
			 Closing
		{
			add
			{
				_closing = (System.EventHandler<Db4o.Events.ObjectContainerEventArgs>)
			 ...
			 Opened
		{
			add
			{
				_opened = (System.EventHandler<Db4o.Events.ObjectContainerEventArgs>)System.Delegate.Combine
					(_opened, value);
			}
			remove
			{
				_opened = (System.EventHandler<Db4o.Events.ObjectContainerEventArgs>)System.Delegate.Remove
					(_opened, value);
			}
		}
