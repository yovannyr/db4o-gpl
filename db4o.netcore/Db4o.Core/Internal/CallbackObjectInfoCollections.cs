...
namespace Db4o.Internal
{
	...
	public class CallbackObjectInfoCollections
	{
		...
		public static readonly Db4o.Internal.CallbackObjectInfoCollections Emtpy
			 = Empty();
		...
		private static Db4o.Internal.CallbackObjectInfoCollections Empty()
		{
			return new Db4o.Internal.CallbackObjectInfoCollections(ObjectInfoCollectionImpl
