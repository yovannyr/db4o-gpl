...
namespace Db4o.Reflect.Generic
{
	...
	public class GenericClass : IReflectClass, IDeepClone
	{
		...
		private Db4o.Reflect.Generic.GenericClass _superclass;

		private Db4o.Reflect.Generic.GenericClass _array;
		...
		public GenericClass(GenericReflector reflector, IReflectClass delegateClass, string
			 name, Db4o.Reflect.Generic.GenericClass superclass)
		{
		...
		public virtual Db4o.Reflect.Generic.GenericClass ArrayClass()
		{
			if (_array != null)
			{
				return _array;
		...
		public virtual object DeepClone(object obj)
		{
			...
			Db4o.Reflect.Generic.GenericClass superClass = null;
			if (_superclass != null)
			{
				_superclass = (Db4o.Reflect.Generic.GenericClass)reflector.ForName(_superclass
					.GetName());
			}
			Db4o.Reflect.Generic.GenericClass ret = new Db4o.Reflect.Generic.GenericClass
		...
		public override bool Equals(object obj)
		{
			...
			Db4o.Reflect.Generic.GenericClass otherGC = (Db4o.Reflect.Generic.GenericClass
				)obj;
		...
		public virtual bool IsAssignableFrom(IReflectClass subclassCandidate)
		{
			...
			if (_delegate != null)
			{
				if (subclassCandidate is Db4o.Reflect.Generic.GenericClass)
				{
					subclassCandidate = ((Db4o.Reflect.Generic.GenericClass)subclassCandidate
						).GetDelegate();
				}
