...
using Db4o.Internal;
using Db4o.Internal.Reflect.Generic;
using Db4o.Reflect;
using Db4o.Reflect.Generic;

namespace Db4o.Reflect.Generic
{
	/// <summary>
	...
	/// <see cref="Db4o.Ext.IExtObjectContainer.Reflector()">Db4o.Ext.IExtObjectContainer.Reflector()
	/// 	</see>
	/// .<br /><br />
	...
	public class GenericReflector : IReflector, IDeepClone
	{
		...
		{
			Db4o.Reflect.Generic.GenericReflector myClone = new Db4o.Reflect.Generic.GenericReflector
		...
		internal virtual Db4o.Reflect.Generic.GenericClass EnsureDelegate(IReflectClass
			 clazz)
		{
			if (clazz == null)
			{
			...
			Db4o.Reflect.Generic.GenericClass claxx = (Db4o.Reflect.Generic.GenericClass
		...
		private Db4o.Reflect.Generic.GenericClass GenericClass(IReflectClass clazz
			)
		{
			Db4o.Reflect.Generic.GenericClass ret;
			...
			{
				ret = new Db4o.Reflect.Generic.GenericClass(this, clazz, name, null);
			}
			return ret;
		}
		...
		/// <seealso cref="Db4o.Reflect.IReflectClass">Db4o.Reflect.IReflectClass
		/// 	</seealso>
		...
		{
			Db4o.Reflect.Generic.GenericClass claxx = genericObject._class;
			if (claxx == null)
			{
			...
			Db4o.Reflect.Generic.GenericClass existingClass = (Db4o.Reflect.Generic.GenericClass
				)ForName(name);
		...
		/// <param name="clazz">class</param>
		public virtual void Register(Db4o.Reflect.Generic.GenericClass clazz)
		{
		...
		{
			public _IClosure4_303(GenericReflector _enclosing, Db4o.Reflect.Generic.GenericClass
				 clazz)
			{
				this._enclosing = _enclosing;
				this.clazz = clazz;
			...
			private readonly Db4o.Reflect.Generic.GenericClass clazz;
		}
		...
		private sealed class _IClosure4_333 : IClosure4
		{
			...
			public object Run()
			{
				Db4o.Reflect.Generic.GenericClass existing = (Db4o.Reflect.Generic.GenericClass
				...
				Db4o.Reflect.Generic.GenericClass claxx = null;
				if (clazz != null)
				{
				...
				{
					claxx = new Db4o.Reflect.Generic.GenericClass(this._enclosing, null, name
						, null);
