...
namespace Db4o.Typehandlers
{
	public interface IInstantiatingTypeHandler : IReferenceTypeHandler
	{
		...
		/// during
		/// <see cref="IReferenceTypeHandler.Activate(Db4o.Marshall.IReferenceActivationContext)
		/// 	">IReferenceTypeHandler.Activate(Db4o.Marshall.IReferenceActivationContext)
		/// 	</see>
		/// </remarks>
