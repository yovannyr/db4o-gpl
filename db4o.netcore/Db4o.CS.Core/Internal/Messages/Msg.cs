...
namespace Db4o.CS.Internal.Messages
{
	...
	public abstract class Msg : System.ICloneable, IMessage
	{
		...
		private static Db4o.CS.Internal.Messages.Msg[] _messages = new Db4o.CS.Internal.Messages.Msg
			[75];
		...
		private Db4o.Internal.Transaction _trans;
		...
		public static Db4o.CS.Internal.Messages.Msg GetMessage(int id)
		{
			return _messages[id];
		}

		public Db4o.CS.Internal.Messages.Msg PublicClone()
		{
			return (Db4o.CS.Internal.Messages.Msg)MemberwiseClone();
		}
		...
		public sealed override bool Equals(object obj)
		{
			...
			return _msgID == ((Db4o.CS.Internal.Messages.Msg)obj)._msgID;
		}
		...
		protected virtual Db4o.Internal.Transaction Transaction()
		{
			return _trans;
		}
		...
		protected static StatefulBuffer ReadMessageBuffer(Db4o.Internal.Transaction
		...
		/// <exception cref="Db4o.Ext.Db4oIOException"></exception>
		public static Db4o.CS.Internal.Messages.Msg ReadMessage(IMessageDispatcher
			 messageDispatcher, Db4o.Internal.Transaction trans, Socket4Adapter socket
			)
		{
			StatefulBuffer reader = ReadMessageBuffer(trans, socket);
			Db4o.CS.Internal.Messages.Msg message = _messages[reader.ReadInt()].ReadPayLoad
				(messageDispatcher, trans, socket, reader);
			return message;
		}

		/// <param name="socket"></param>
		internal virtual Db4o.CS.Internal.Messages.Msg ReadPayLoad(IMessageDispatcher
			 messageDispatcher, Db4o.Internal.Transaction a_trans, Socket4Adapter
			 socket, ByteArrayBuffer reader)
		{
			Db4o.CS.Internal.Messages.Msg msg = PublicClone();
			msg.SetMessageDispatcher(messageDispatcher);
			msg.SetTransaction(CheckParentTransaction(a_trans, reader));
			return msg;
		}

		protected Db4o.Internal.Transaction CheckParentTransaction(Db4o.Internal.Transaction
		...
		public void SetTransaction(Db4o.Internal.Transaction aTrans)
		{
			_trans = aTrans;
		}
		...
		public virtual void Write(Db4o.CS.Internal.Messages.Msg msg)
		{
		...
		public virtual Db4o.CS.Internal.Messages.Msg RespondInt(int response)
		{
		...
		protected virtual Db4o.Internal.Transaction SystemTransaction()
		{
