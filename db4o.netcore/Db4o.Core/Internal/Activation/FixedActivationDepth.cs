...
namespace Db4o.Internal.Activation
{
	...
	public class FixedActivationDepth : ActivationDepthImpl
	{
		...
		public override IActivationDepth Descend(ClassMetadata metadata)
		{
			...
			return new Db4o.Internal.Activation.FixedActivationDepth(_depth - 1, _mode
				);
		}

		// TODO code duplication in fixed activation/update depth
		public virtual Db4o.Internal.Activation.FixedActivationDepth AdjustDepthToBorders
			()
		{
			return new Db4o.Internal.Activation.FixedActivationDepth(DepthUtil.AdjustDepthToBorders
				(_depth));
		}
	}
}
