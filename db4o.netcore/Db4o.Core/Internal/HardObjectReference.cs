...
namespace Db4o.Internal
{
	...
	{
		public static readonly Db4o.Internal.HardObjectReference Invalid = new 
			Db4o.Internal.HardObjectReference(null, null);
		...
		public static Db4o.Internal.HardObjectReference PeekPersisted(Transaction
			 trans, int id, int depth)
		{
			...
			return new Db4o.Internal.HardObjectReference(@ref, obj);
		}
