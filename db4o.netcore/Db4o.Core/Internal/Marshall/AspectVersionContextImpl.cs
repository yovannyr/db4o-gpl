...
namespace Db4o.Internal.Marshall
{
	...
	public class AspectVersionContextImpl : IAspectVersionContext
	{
		...
		public static readonly Db4o.Internal.Marshall.AspectVersionContextImpl
			 AlwaysEnabled = new Db4o.Internal.Marshall.AspectVersionContextImpl(
			int.MaxValue);

		public static readonly Db4o.Internal.Marshall.AspectVersionContextImpl
			 CheckAlwaysEnabled = new Db4o.Internal.Marshall.AspectVersionContextImpl
			(int.MaxValue - 1);

		public static IAspectVersionContext ForSize(int count)
		{
			return new Db4o.Internal.Marshall.AspectVersionContextImpl(count);
		}
	}
}
