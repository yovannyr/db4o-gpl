...
namespace Db4o
{
	...
	public interface IEmbeddedObjectContainer : IObjectContainer
	{
		...
		/// .
		/// <see cref="Db4o.Ext.IExtObjectContainer.Backup(Db4o.IO.IStorage, string)
		/// 	">backup(com.db4o.io.Storage, String)</see>
		/// .
		/// </remarks>
		/// <param name="path">a the path to the backup file</param>
		/// <exception cref="Db4o.Ext.DatabaseClosedException">db4o database file was closed or failed to open.
		/// 	</exception>
