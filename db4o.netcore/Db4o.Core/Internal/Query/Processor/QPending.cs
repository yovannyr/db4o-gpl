...
namespace Db4o.Internal.Query.Processor
{
	...
	public class QPending : Tree
	{
		...
		{
			return _constraint.Id() - ((Db4o.Internal.Query.Processor.QPending)a_to
				)._constraint.Id();
		}
		...
		{
			Db4o.Internal.Query.Processor.QPending pending = InternalClonePayload(
				);
			base.ShallowCloneInternal(pending);
			return pending;
		}

		internal virtual Db4o.Internal.Query.Processor.QPending InternalClonePayload
			()
		{
			Db4o.Internal.Query.Processor.QPending pending = new Db4o.Internal.Query.Processor.QPending
