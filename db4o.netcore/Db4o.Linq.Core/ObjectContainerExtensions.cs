...
namespace Db4o.Linq
{
	public static class ObjectContainerExtensions
	{
		...
		/// in <see cref="Db4o.Linq.IDb4oLinqQuery">IDb4oLinqQuery</see>. The optimized methods are defined as extension methods
		/// on the <see cref="Db4o.Linq.IDb4oLinqQuery">IDb4oLinqQuery</see> marker interface.
		/// </summary>
		...
		/// <returns>A <see cref="Db4o.Linq.IDb4oLinqQuery">IDb4oLinqQuery</see> marker interface</returns>
