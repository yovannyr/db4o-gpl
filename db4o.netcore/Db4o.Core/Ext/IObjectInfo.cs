...
namespace Db4o.Ext
{
	...
	public interface IObjectInfo
	{
		...
		/// to use this feature:
		/// <see cref="Db4o.Config.IFileConfiguration.GenerateUUIDs(Db4o.Config.ConfigScope)
		/// 	">Db4o.Config.IFileConfiguration.GenerateUUIDs(Db4o.Config.ConfigScope)
		/// 	</see>
		/// </remarks>
		...
		/// <see cref="Db4o.Config.IFileConfiguration.GenerateVersionNumbers(Db4o.Config.ConfigScope)
		/// 	">Db4o.Config.IFileConfiguration.GenerateVersionNumbers(Db4o.Config.ConfigScope)
		/// 	</see>
		/// <br />
		...
		/// <see cref="Db4o.Config.IFileConfiguration.GenerateCommitTimestamps(bool)
		/// 	">Db4o.Config.IFileConfiguration.GenerateCommitTimestamps(bool)</see>
		/// .<br />
		/// <br />
		...
		/// <seealso cref="Db4o.Config.IFileConfiguration.GenerateCommitTimestamps(bool)
		/// 	">Db4o.Config.IFileConfiguration.GenerateCommitTimestamps(bool)</seealso>
		/// <since>8.0</since>
