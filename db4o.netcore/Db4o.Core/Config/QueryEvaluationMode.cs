...
namespace Db4o.Config
{
	...
	public class QueryEvaluationMode
	{
		...
		/// when
		/// <see cref="Db4o.Query.IQuery.Execute()">Db4o.Query.IQuery.Execute()
		/// 	</see>
		/// is called.
		/// <br /><br /><b>For detailed documentation please see
		/// <see cref="IQueryConfiguration.EvaluationMode(QueryEvaluationMode)">IQueryConfiguration.EvaluationMode(QueryEvaluationMode)
		...
		/// </b>
		/// </remarks>
		public static readonly Db4o.Config.QueryEvaluationMode Immediate = new 
			Db4o.Config.QueryEvaluationMode("IMMEDIATE");
		...
		/// the
		/// <see cref="Db4o.IObjectSet">Db4o.IObjectSet</see>
		...
		/// </b>
		/// </remarks>
		public static readonly Db4o.Config.QueryEvaluationMode Snapshot = new 
			Db4o.Config.QueryEvaluationMode("SNAPSHOT");
		...
		/// </b>
		/// </remarks>
		public static readonly Db4o.Config.QueryEvaluationMode Lazy = new Db4o.Config.QueryEvaluationMode
			("LAZY");

		private static readonly Db4o.Config.QueryEvaluationMode[] Modes = new 
			Db4o.Config.QueryEvaluationMode[] { Db4o.Config.QueryEvaluationMode
			.Immediate, Db4o.Config.QueryEvaluationMode.Snapshot, Db4o.Config.QueryEvaluationMode
			.Lazy };
		...
		/// <summary>internal method, ignore please.</summary>
		/// <remarks>internal method, ignore please.</remarks>
		public static Db4o.Config.QueryEvaluationMode FromInt(int i)
		{
			return Modes[i];
		}
