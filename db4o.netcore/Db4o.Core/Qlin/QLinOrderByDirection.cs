...
namespace Db4o.Qlin
{
	...
	public class QLinOrderByDirection
	{
		...
		internal static readonly Db4o.Qlin.QLinOrderByDirection Ascending = new 
			Db4o.Qlin.QLinOrderByDirection("ascending", true);

		internal static readonly Db4o.Qlin.QLinOrderByDirection Descending = new 
			Db4o.Qlin.QLinOrderByDirection("descending", false);
