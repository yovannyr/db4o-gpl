...
namespace Db4o.Internal.Ids
{
	...
	{
		private readonly Db4o.Internal.Slots.Slot _slot;

		public IdSlotTree(int id, Db4o.Internal.Slots.Slot slot) : base(id)
		{
			_slot = slot;
		}
		...
		public override object Read(ByteArrayBuffer buffer)
		{
			...
			Db4o.Internal.Slots.Slot slot = new Db4o.Internal.Slots.Slot
				(buffer.ReadInt(), buffer.ReadInt());
			return new Db4o.Internal.Ids.IdSlotTree(id, slot);
		}
