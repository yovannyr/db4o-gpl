...
namespace Db4o.TA
{
	...
	public interface IActivatable
	{
		...
		/// <see cref="Db4o.Activation.IActivator.Activate(Db4o.Activation.ActivationPurpose)
		/// 	">Db4o.Activation.IActivator.Activate(Db4o.Activation.ActivationPurpose)
		/// 	</see>
		/// on the
		/// <see cref="Db4o.Activation.IActivator">Db4o.Activation.IActivator
		/// 	</see>
		/// that was previously passed to
		/// <see cref="Bind(Db4o.Activation.IActivator)">Bind(Db4o.Activation.IActivator)
		/// 	</see>
		/// .
		/// </remarks>
		/// <param name="purpose">
		/// Whereever this object is accessed to read or write. See
		/// <see cref="Db4o.Activation.ActivationPurpose">Db4o.Activation.ActivationPurpose
		/// 	</see>
		/// </param>
