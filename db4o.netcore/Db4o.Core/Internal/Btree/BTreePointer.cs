...
namespace Db4o.Internal.Btree
{
	...
	{
		public static Db4o.Internal.Btree.BTreePointer Max(Db4o.Internal.Btree.BTreePointer
			 x, Db4o.Internal.Btree.BTreePointer y)
		{
			if (x == null)
			{
				return x;
		...
		public static Db4o.Internal.Btree.BTreePointer Min(Db4o.Internal.Btree.BTreePointer
			 x, Db4o.Internal.Btree.BTreePointer y)
		{
			if (x == null)
			{
		...
		public Db4o.Internal.Btree.BTreePointer ShallowClone()
		{
			return new Db4o.Internal.Btree.BTreePointer(_transaction, _nodeReader, 
				_node, _index);
		}

		public void CopyTo(Db4o.Internal.Btree.BTreePointer target)
		{
			target._node = _node;
		...
		public Db4o.Internal.Btree.BTreePointer Next()
		{
			...
			return new Db4o.Internal.Btree.BTreePointer(_transaction, nextReader, 
				nextNode, newIndex);
		}
		...
		/// state the stay the same.
		/// </remarks>
		public Db4o.Internal.Btree.BTreePointer UnsafeFastNext()
		{
			int indexInMyNode = _index + 1;
			while (indexInMyNode < _node.Count())
			{
		...
		public Db4o.Internal.Btree.BTreePointer Previous()
		{
			int indexInMyNode = _index - 1;
			...
			return new Db4o.Internal.Btree.BTreePointer(_transaction, previousReader
		...
		public override bool Equals(object obj)
		{
			...
			if (!(obj is Db4o.Internal.Btree.BTreePointer))
			{
				return false;
			}
			Db4o.Internal.Btree.BTreePointer other = (Db4o.Internal.Btree.BTreePointer
				)obj;
		...
		public int CompareTo(Db4o.Internal.Btree.BTreePointer y)
		{
			if (null == y)
			{
				throw new ArgumentNullException();
		...
		public static bool LessThan(Db4o.Internal.Btree.BTreePointer x, Db4o.Internal.Btree.BTreePointer
			 y)
		{
			return Db4o.Internal.Btree.BTreePointer.Min(x, y) == x && !Equals(x, y
				);
		}

		public static bool Equals(Db4o.Internal.Btree.BTreePointer x, Db4o.Internal.Btree.BTreePointer
			 y)
		{
			if (x == null)
			{
