...
namespace Db4o.Internal.Query.Processor
{
	...
	public class QCandidate : QCandidateBase, IParentCandidate
	{
		...
		internal Db4o.Internal.ClassMetadata _classMetadata;
		...
		{
			Db4o.Internal.Query.Processor.QCandidate qcan = new Db4o.Internal.Query.Processor.QCandidate
		...
		{
			Db4o.Internal.ClassMetadata classMetadata = candidate.ClassMetadata();
		...
		private sealed class _IClosure4_205 : IClosure4
		{
			...
			public object Run()
			{
				...
				while (i.MoveNext())
				{
					...
					candidates.Add(new Db4o.Internal.Query.Processor.QCandidate(candidates
						, obj, 0));
				}
				return null;
			}
		...
		private FieldMetadata FieldMetadataFrom(QField qField, Db4o.Internal.ClassMetadata
			 type)
		{
		...
		private Db4o.Internal.Marshall.MarshallerFamily MarshallerFamily()
		{
			return Db4o.Internal.Marshall.MarshallerFamily.Version(_handlerVersion
				);
		}
			...
			, object constraint)
		{
			...
			Db4o.Internal.ClassMetadata classMetadata = null;
			if (_bytes != null)
			{
