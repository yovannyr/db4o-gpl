...
namespace Db4o.Internal
{
	...
	public sealed class DefragmentContextImpl : IReadWriteBuffer, IDefragmentContext
	{
		...
		public DefragmentContextImpl(ByteArrayBuffer source, Db4o.Internal.DefragmentContextImpl
		...
		public DefragmentContextImpl(Db4o.Internal.DefragmentContextImpl parentContext
			, ObjectHeader header)
		{
		...
		public Db4o.Internal.Transaction SystemTrans()
		{
			return Transaction();
		}
			 ...
			 command, ByteArrayBuffer sourceReader)
		{
			...
			Db4o.Internal.DefragmentContextImpl context = new Db4o.Internal.DefragmentContextImpl
		...
		public Db4o.Internal.Marshall.SlotFormat SlotFormat()
		{
