...
namespace Db4o.Internal
{
	...
	public class LocalTransaction : Transaction
	{
		...
		private Db4o.Internal.CommitTimestampSupport _commitTimestampSupport = 
			null;
		...
		private Db4o.Internal.LocalTransaction ParentLocalTransaction()
		{
			return (Db4o.Internal.LocalTransaction)_systemTransaction;
		}
		...
		public virtual Db4o.Internal.CommitTimestampSupport CommitTimestampSupport
			()
		{
			if (!IsSystemTransaction())
			{
			...
			{
				_commitTimestampSupport = new Db4o.Internal.CommitTimestampSupport(LocalContainer
					());
			}
