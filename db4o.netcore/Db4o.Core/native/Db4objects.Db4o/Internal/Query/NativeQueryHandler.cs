...
namespace Db4o.Internal.Query
{
	public class NativeQueryHandler
	{
        ...
        public virtual Db4o.IObjectSet Execute(Db4o.Query.IQuery query, Db4o.Query.Predicate predicate, Db4o.Query.IQueryComparator comparator)
		{
			Db4o.Query.IQuery q = ConfigureQuery(query, predicate);
			q.SortBy(comparator);
			return q.Execute();
		}

        public virtual System.Collections.Generic.IList<Extent> Execute<Extent>(Db4o.Query.IQuery query, System.Predicate<Extent> match,
																				Db4o.Query.IQueryComparator comparator)
		{
#if CF
		...
		private System.Collections.Generic.IList<Extent> ExecuteImpl<Extent>(
																		...
																		Db4o.Query.IQueryComparator comparator)
		{
			Db4o.Query.IQuery q = QueryForExtent<Extent>(query, comparator);
			try
			{
        ...
        private Db4o.Query.IQuery QueryForExtent<Extent>(Db4o.Query.IQuery query, Db4o.Query.IQueryComparator comparator)
		{
		...
		private static System.Collections.Generic.IList<Extent> WrapQueryResult<Extent>(Db4o.Query.IQuery query)
		{
			IQueryResult queryResult = ((QQuery)query).GetQueryResult();
			return new GenericObjectSetFacade<Extent>(queryResult);
		}

        private Db4o.Query.IQuery ConfigureQuery(Db4o.Query.IQuery query, Db4o.Query.Predicate predicate)
		{
			...
			query.Constrain(new Db4o.Internal.Query.PredicateEvaluation(predicate));
		...
		void OptimizeQuery(Db4o.Query.IQuery q, object predicate, System.Reflection.MethodBase filterMethod)
		{
			if (_builder == null)
	...
	class GenericPredicateEvaluation<T> : DelegateEnvelope, Db4o.Query.IEvaluation
	{
		...
		public void Evaluate(Db4o.Query.ICandidate candidate)
		{
