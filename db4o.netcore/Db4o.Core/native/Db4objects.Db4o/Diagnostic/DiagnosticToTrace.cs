...
namespace Db4o.Diagnostic
{
    ...
    /// Install this
    /// <see cref="Db4o.Diagnostic.IDiagnosticListener">Db4o.Diagnostic.IDiagnosticListener
    /// 	</see>
    /// with: <br />
    /// <code>commonConfig.Diagnostic.AddListener(new DiagnosticToTrace());</code><br />
    /// </remarks>
    /// <seealso cref="Db4o.Diagnostic.DiagnosticConfiguration">Db4o.Diagnostic.DiagnosticConfiguration
    /// 	</seealso>
    public class DiagnosticToTrace : Db4o.Diagnostic.IDiagnosticListener
    {
        ...
        public virtual void OnDiagnostic(Db4o.Diagnostic.IDiagnostic d)
        {
#if !SILVERLIGHT        	
