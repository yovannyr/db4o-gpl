...
namespace Db4o.Defragment
{
	...
	public class DefragmentConfig
	{
		...
		/// during the defragment process.
		/// </param>
		[System.ObsoleteAttribute(@"since 7.9: use Db4oConfig(Db4o.Config.IEmbeddedConfiguration) instead"
			)]
		...
		/// <param name="config">
		/// The db4o
		/// <see cref="Db4o.Config.IEmbeddedConfiguration">IEmbeddedConfiguration</see>
		/// to be applied
		/// during the defragment process.
		/// </param>
		/// <since>7.9</since>
