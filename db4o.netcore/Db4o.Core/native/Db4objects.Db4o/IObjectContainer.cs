...
namespace Db4o
{
	...
	/// <see cref="Db4o.Db4o.OpenServer">db4o server</see>
	/// .
	...
	/// <seealso cref="Db4o.Ext.IExtObjectContainer">IExtObjectContainer for extended functionality.
	/// </seealso>
	public interface IObjectContainer : System.IDisposable, ISodaQueryFactory
	{
		...
		/// <param name="depth">
		/// the member
		/// <see cref="Db4o.Config.IConfiguration.ActivationDepth">depth</see>
        ...
        /// <see cref="Db4o.IObjectContainer.Commit">Commit()</see>.
        /// </remarks>
		/// <returns>
		...
		/// </remarks>
		/// <seealso cref="Db4o.Ext.IObjectCallbacks">Using callbacks</seealso>
		/// <seealso cref="Db4o.Config.IConfiguration.ActivationDepth">Why activation?</seealso>
		...
		/// </remarks>
		/// <seealso cref="Db4o.Config.IObjectClass.CascadeOnDelete">Db4o.Config.IObjectClass.CascadeOnDelete
		/// 	</seealso>
		/// <seealso cref="Db4o.Config.IObjectField.CascadeOnDelete">Db4o.Config.IObjectField.CascadeOnDelete
		/// 	</seealso>
		/// <seealso cref="Db4o.Ext.IObjectCallbacks">Using callbacks</seealso>
		/// <param name="obj">
		...
		Db4o.Ext.IExtObjectContainer Ext();
        ...
        /// <seealso cref="Db4o.Config.IConfiguration.ActivationDepth">Why activation?</seealso>
        /// <seealso cref="Db4o.Ext.IObjectCallbacks">Using callbacks</seealso>
        Db4o.IObjectSet QueryByExample(object template);


		/// <summary>
		/// Creates a new SODA
		/// <see cref="Db4o.Query.IQuery">Query</see>
		...
		/// </returns>
		Db4o.IObjectSet Query(System.Type clazz);
        ...
        /// <br/><br/>
        /// Make sure that you reference Db4o.NativeQueries.dll, Mono.Cecil.dll and Cecil.FlowAnalysis.dll in your application
		...
		/// the query result
		/// </returns>
		Db4o.IObjectSet Query(Db4o.Query.Predicate predicate);
		...
		/// <param name="predicate">
		/// the
		/// <see cref="Db4o.Query.Predicate">predicate</see>
		/// containing the native query expression.
		/// </param>
		/// <param name="comparator">
		/// the
		/// <see cref="Db4o.Query.IQueryComparator">comperator</see>
		/// specifiying the sort order of the result
		/// </param>
        /// <returns>
        /// the query result
		/// </returns>
		Db4o.IObjectSet Query(Db4o.Query.Predicate predicate, Db4o.Query.IQueryComparator
			 comparator);
        ...
        /// the query result
        /// </returns>
		Db4o.IObjectSet Query(Db4o.Query.Predicate predicate, System.Collections.IComparer comparer);
        ...
        /// <seealso cref="Db4o.Ext.IExtObjectContainer.Store">IExtObjectContainer#Store(object, depth)
        /// 	</seealso>
        /// <seealso cref="Db4o.Config.IConfiguration.UpdateDepth">Db4o.Config.ICommonConfiguration.UpdateDepth
        /// 	</seealso>
        /// <seealso cref="Db4o.Config.IObjectClass.UpdateDepth">Db4o.Config.IObjectClass.UpdateDepth
        /// 	</seealso>
        /// <seealso cref="Db4o.Config.IObjectClass.CascadeOnUpdate">Db4o.Config.IObjectClass.CascadeOnUpdate
        /// 	</seealso>
        /// <seealso cref="Db4o.Config.IObjectField.CascadeOnUpdate">Db4o.Config.IObjectField.CascadeOnUpdate
        /// 	</seealso>
        /// <seealso cref="Db4o.Ext.IObjectCallbacks">Using callbacks</seealso>
