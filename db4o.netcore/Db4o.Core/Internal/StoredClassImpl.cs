...
namespace Db4o.Internal
{
	...
	public class StoredClassImpl : IStoredClass
	{
		...
		public virtual IStoredClass GetParentStoredClass()
		{
			...
			return new Db4o.Internal.StoredClassImpl(_transaction, parentClassMetadata
				);
		}
		...
		public override bool Equals(object obj)
		{
			...
			return _classMetadata.Equals(((Db4o.Internal.StoredClassImpl)obj)._classMetadata
				);
		}
