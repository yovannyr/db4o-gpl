...
namespace Db4o.Foundation
{
	...
	public class HashtableLongEntry : HashtableIntEntry
	{
		...
		{
			return DeepCloneInternal(new Db4o.Foundation.HashtableLongEntry(), obj
				);
		}
		...
		protected override HashtableIntEntry DeepCloneInternal(HashtableIntEntry entry, object
			 obj)
		{
			((Db4o.Foundation.HashtableLongEntry)entry)._longKey = _longKey;
			return base.DeepCloneInternal(entry, obj);
		}

		public override bool SameKeyAs(HashtableIntEntry other)
		{
			return other is Db4o.Foundation.HashtableLongEntry ? ((Db4o.Foundation.HashtableLongEntry
