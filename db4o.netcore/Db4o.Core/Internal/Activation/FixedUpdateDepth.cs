...
namespace Db4o.Internal.Activation
{
	public abstract class FixedUpdateDepth : IUpdateDepth
	{
		...
		public virtual bool IsBroaderThan(Db4o.Internal.Activation.FixedUpdateDepth
			 other)
		{
		...
		public virtual Db4o.Internal.Activation.FixedUpdateDepth AdjustDepthToBorders
			()
		{
		...
		public override bool Equals(object other)
		{
			...
			return _depth == ((Db4o.Internal.Activation.FixedUpdateDepth)other)._depth;
		}
		...
		protected abstract Db4o.Internal.Activation.FixedUpdateDepth ForDepth(
			int depth);
