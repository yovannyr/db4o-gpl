...
namespace Db4o.Internal.Activation
{
	...
	public class ActivationContext4 : IActivationContext
	{
		...
		public ActivationContext4(Db4o.Internal.Transaction transaction, object
		...
		public virtual void CascadeActivationToChild(object obj)
		{
			...
			Db4o.Internal.ClassMetadata classMetadata = cascadingContext.ClassMetadata
				();
		...
		private void CascadeActivation(IActivationContext context)
		{
			...
			else
			{
				...
				Db4o.Internal.ClassMetadata classMetadata = context.ClassMetadata();
		...
		{
			return new Db4o.Internal.Activation.ActivationContext4(Transaction(), 
