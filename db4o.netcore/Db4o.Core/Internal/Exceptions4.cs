...
namespace Db4o.Internal
{
	...
	public class Exceptions4
	{
			 ...
			 doLog)
		{
			if (doLog)
			{
				Db4o.Internal.Messages.LogErr(Db4oFactory.Configure(), code, msg, cause
					);
			}
			throw new Db4oException(Db4o.Internal.Messages.Get(code, msg));
		}

		/// <exception cref="Db4o.Ext.Db4oException"></exception>
