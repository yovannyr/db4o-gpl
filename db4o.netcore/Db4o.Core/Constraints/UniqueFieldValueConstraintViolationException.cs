...
namespace Db4o.Constraints
{
	...
	/// is violated.<br /><br />
	/// </summary>
	/// <seealso cref="Db4o.Config.IObjectField.Indexed(bool)">Db4o.Config.IObjectField.Indexed(bool)
	/// 	</seealso>
	/// <seealso cref="Db4o.Config.ICommonConfiguration.Add(Db4o.Config.IConfigurationItem)
