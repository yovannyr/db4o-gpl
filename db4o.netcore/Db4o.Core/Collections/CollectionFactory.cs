...
namespace Db4o.Collections
{
	...
	public class CollectionFactory
	{
		...
		public static Db4o.Collections.CollectionFactory ForObjectContainer(IObjectContainer
			 objectContainer)
		{
			...
			return new Db4o.Collections.CollectionFactory(objectContainer);
		}
		...
		/// </remarks>
		/// <returns></returns>
		public virtual Db4o.Collections.ISet<E> NewBigSet<E>()
		{
