...
namespace Db4o.TA
{
	...
	/// </remarks>
	/// <seealso cref="Db4o.TA.TransparentPersistenceSupport"/>
	public class TransparentActivationSupport : IConfigurationItem
	{
		...
		/// <seealso cref="TransparentPersistenceSupport.Apply(Db4o.Internal.IInternalObjectContainer)
		/// 	">TransparentPersistenceSupport.Apply(Db4o.Internal.IInternalObjectContainer)
		/// 	</seealso>
		public virtual void Apply(IInternalObjectContainer container)
		{
			...
			registry.Instantiated += new System.EventHandler<Db4o.Events.ObjectInfoEventArgs>
				(new _IEventListener4_45(this).OnEvent);
			registry.Created += new System.EventHandler<Db4o.Events.ObjectInfoEventArgs>
				(new _IEventListener4_50(this).OnEvent);
			registry.Closing += new System.EventHandler<Db4o.Events.ObjectContainerEventArgs>
			...
			TransparentActivationSupport.TADiagnosticProcessor processor = new TransparentActivationSupport.TADiagnosticProcessor
				(this, container);
			registry.ClassRegistered += new System.EventHandler<Db4o.Events.ClassEventArgs>
		...
		private sealed class _IEventListener4_45
		{
			...
			public void OnEvent(object sender, Db4o.Events.ObjectInfoEventArgs args
				)
			{
		...
		private sealed class _IEventListener4_56
		{
			...
			public void OnEvent(object sender, Db4o.Events.ObjectContainerEventArgs
				 args)
			{
		...
		private sealed class _IEventListener4_67
		{
			...
			public void OnEvent(object sender, Db4o.Events.ClassEventArgs args)
			{
		...
		{
			Db4o.Internal.Transaction transaction = container.Transaction;
		...
		private void BindActivatableToActivator(ObjectEventArgs oea)
		{
			...
			{
				Db4o.Internal.Transaction transaction = (Db4o.Internal.Transaction
					)oea.Transaction();
		...
		private IActivator ActivatorForObject(Db4o.Internal.Transaction transaction
		...
		private bool IsEmbeddedClient(Db4o.Internal.Transaction transaction)
		{
			return IsEmbeddedClient(transaction.ObjectContainer());
		}

		internal virtual Db4o.Internal.Transaction Transaction(EventArgs args)
		{
			return (Db4o.Internal.Transaction)((TransactionalEventArgs)args).Transaction
				();
		}
