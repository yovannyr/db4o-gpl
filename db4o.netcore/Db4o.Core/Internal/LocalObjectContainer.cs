...
using Db4o.Internal.Fileheader;
...
namespace Db4o.Internal
{
		...
		, IEmbeddedObjectContainer
	{
		...
		private Db4o.Internal.SystemData _systemData;
		...
		{
			_systemData = new Db4o.Internal.SystemData();
		...
		public virtual Db4o.Internal.SystemData SystemData()
		{
			return _systemData;
		}
