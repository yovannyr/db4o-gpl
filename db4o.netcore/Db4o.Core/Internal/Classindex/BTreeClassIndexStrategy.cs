...
namespace Db4o.Internal.Classindex
{
	/// <exclude></exclude>
	public class BTreeClassIndexStrategy : AbstractClassIndexStrategy
	{
		...
		public static BTree Btree(ClassMetadata clazz)
		{
			...
			if (!(index is Db4o.Internal.Classindex.BTreeClassIndexStrategy))
			{
				throw new InvalidOperationException();
			}
			return ((Db4o.Internal.Classindex.BTreeClassIndexStrategy)index).Btree
				();
		}
