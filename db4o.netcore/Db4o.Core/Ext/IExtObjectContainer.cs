...
namespace Db4o.Ext
{
	...
	/// <see cref="Db4o.IObjectContainer.Ext()">ObjectContainer.ext()</see>
	...
	public partial interface IExtObjectContainer : IObjectContainer
	{
		...
		/// <see cref="Db4o.Config.ICommonConfiguration.ActivationDepth()">Db4o.Config.ICommonConfiguration.ActivationDepth()
		/// 	</see>
		/// )
		/// and all configured settings for
		/// <see cref="Db4o.Config.IObjectClass.MaximumActivationDepth(int)">Db4o.Config.IObjectClass.MaximumActivationDepth(int)
		/// 	</see>
		/// 
		/// and
		/// <see cref="Db4o.Config.IObjectClass.MaximumActivationDepth(int)">Db4o.Config.IObjectClass.MaximumActivationDepth(int)
		...
		/// <see cref="Db4o.TA.TransparentActivationSupport">Db4o.TA.TransparentActivationSupport
		/// 	</see>
		/// )
		/// the parameter object will only be activated, if it does not implement
		/// <see cref="Db4o.TA.IActivatable">Db4o.TA.IActivatable</see>
		...
		/// <exception cref="Db4o.Ext.DatabaseClosedException"></exception>
		...
		/// <see cref="Db4o.IObjectContainer.Store(object)">store(Object)</see>
		/// is
		...
		/// database IDs.
		/// </exception>
		/// <exception cref="Db4o.Ext.InvalidIDException"></exception>
		/// <exception cref="Db4o.Ext.DatabaseClosedException"></exception>
		...
		/// </returns>
		/// <seealso cref="Db4o.Config.ICommonConfiguration.ActivationDepth()">Why activation?
		/// 	</seealso>
		/// <exception cref="DatabaseClosedException">db4o database file was closed or failed to open.
		/// 	</exception>
		...
		/// <see cref="Db4o.IObjectContainer.Store(object)">Db4o.IObjectContainer.Store(object)
		/// 	</see>
		/// .
		...
		/// <param name="depth">
		/// the member
		/// <see cref="Db4o.Config.IConfiguration.ActivationDepth(int)">depth</see>
		...
		/// <see cref="Db4o.IObjectContainer.Store(object)">ObjectContainer#store(Object)
		/// 	</see>
		/// ,
		...
		/// <see cref="Db4o.IObjectContainer">ObjectContainers</see>
		/// .
		/// <br /><br />
		...
		/// <see cref="Db4o.IObjectServer">Db4o.IObjectServer</see>
		/// is
		...
		/// <see cref="Db4o.IObjectContainer.Commit()">Db4o.IObjectContainer.Commit()
		/// 	</see>
		/// or
		/// <see cref="Db4o.IObjectContainer.Rollback()">Db4o.IObjectContainer.Rollback()
		/// 	</see>
