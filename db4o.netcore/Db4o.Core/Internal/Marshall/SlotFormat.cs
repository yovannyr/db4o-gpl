...
namespace Db4o.Internal.Marshall
{
	...
	public abstract class SlotFormat
	{
		...
		private static readonly Db4o.Internal.Marshall.SlotFormat CurrentSlotFormat
		...
		public static Db4o.Internal.Marshall.SlotFormat ForHandlerVersion(int 
			handlerVersion)
		{
			...
			Db4o.Internal.Marshall.SlotFormat slotFormat = (Db4o.Internal.Marshall.SlotFormat
		...
		{
			if (!(obj is Db4o.Internal.Marshall.SlotFormat))
			{
				return false;
			}
			return HandlerVersion() == ((Db4o.Internal.Marshall.SlotFormat)obj).HandlerVersion
				();
		}
		...
		public static Db4o.Internal.Marshall.SlotFormat Current()
		{
			return CurrentSlotFormat;
		}
