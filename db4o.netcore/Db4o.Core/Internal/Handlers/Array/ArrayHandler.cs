...
namespace Db4o.Internal.Handlers.Array
{
		...
		, IVariableLengthTypeHandler, IVersionedTypeHandler, IQueryableTypeHandler
	{
		...
		{
			if (!(obj is Db4o.Internal.Handlers.Array.ArrayHandler))
			{
				return false;
			}
			Db4o.Internal.Handlers.Array.ArrayHandler other = (Db4o.Internal.Handlers.Array.ArrayHandler
				)obj;
		...
		protected IReflectClass ClassReflector(IReflector reflector, Db4o.Internal.ClassMetadata
		...
		public static IEnumerator Iterator(IReflectClass claxx, object obj)
		{
			...
			return Db4o.Internal.Handlers.Array.ArrayHandler.AllElements(reflectArray
				, obj);
		}
		...
		protected bool IsPrimitive(IReflector reflector, IReflectClass claxx, Db4o.Internal.ClassMetadata
			 classMetadata)
		{
		...
		{
			Db4o.Internal.ClassMetadata classMetadata = ClassMetadata(context, info
				);
			return HandlerRegistry.CorrectHandlerVersion(context, handler, classMetadata);
		}

		private Db4o.Internal.ClassMetadata ClassMetadata(IDefragmentContext context
			, ArrayInfo info)
		{
		...
		protected void Analyze(ObjectContainerBase container, object obj, ArrayInfo info)
		{
			...
			Db4o.Internal.ClassMetadata classMetadata = container.ProduceClassMetadata
				(claxx);
		...
		{
			return new Db4o.Internal.Handlers.Array.ArrayHandler();
		}
		...
		public virtual object DeepClone(object context)
		{
			...
			Db4o.Internal.Handlers.Array.ArrayHandler original = (Db4o.Internal.Handlers.Array.ArrayHandler
				)typeHandlerCloneContext.original;
			Db4o.Internal.Handlers.Array.ArrayHandler cloned = (Db4o.Internal.Handlers.Array.ArrayHandler
