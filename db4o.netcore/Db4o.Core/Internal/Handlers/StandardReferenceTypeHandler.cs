...
namespace Db4o.Internal.Handlers
{
		...
		, IReadsObjectIds
	{
		...
		private Db4o.Internal.ClassMetadata _classMetadata;

		public StandardReferenceTypeHandler(Db4o.Internal.ClassMetadata classMetadata
			)
		{
		...
		private sealed class _MarshallingInfoTraverseAspectCommand_35 : MarshallingInfoTraverseAspectCommand
		{
			...
			protected override int InternalDeclaredAspectCount(Db4o.Internal.ClassMetadata
				 classMetadata)
			{
