...
namespace Db4o.Internal
{
	...
	{
		private readonly Db4o.Internal.Slots.SlotChangeFactory _slotChangeFactory;

		private int[] _ints;

		public PersistentIntegerArray(Db4o.Internal.Slots.SlotChangeFactory slotChangeFactory
