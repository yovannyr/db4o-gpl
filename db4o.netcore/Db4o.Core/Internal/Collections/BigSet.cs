...
using Db4o.Internal.Collections;
using Db4o.Marshall;

namespace Db4o.Internal.Collections
{
	/// <exclude></exclude>
	public partial class BigSet<E> : Db4o.Collections.ISet<E>, IBigSetPersistence
	{
		private Db4o.Internal.Btree.BTree _bTree;

		private Db4o.Internal.Transaction _transaction;
		...
		private Db4o.Internal.Transaction Transaction()
		{
			return _transaction;
		}

		private Db4o.Internal.Transaction SystemTransaction()
		{
		...
		private Db4o.Internal.Btree.BTree BTree()
		{
			if (_bTree == null)
			{
				throw new InvalidOperationException();
		...
		private Db4o.Internal.Btree.BTree BTreeForUpdate()
		{
			Db4o.Internal.Btree.BTree bTree = BTree();
